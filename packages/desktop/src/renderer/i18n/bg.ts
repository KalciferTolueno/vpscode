export const dict = {
  ...
  "desktop.updater.none.message": "Вече използвате най-новата версия на VPS Code",
  ...
  "desktop.updater.downloaded.prompt":
    "Версия {{version}} от VPS Code е изтеглена. Искате ли да я инсталирате и рестартирате?",
