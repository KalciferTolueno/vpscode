export const dict = {
  ...
  "desktop.updater.none.message": "Stai già utilizzando l'ultima versione di VPS Code",
  ...
  "desktop.updater.downloaded.prompt":
    "La versione {{version}} di VPS Code è stata scaricata. Vuoi installarla e riavviare l'app?",
