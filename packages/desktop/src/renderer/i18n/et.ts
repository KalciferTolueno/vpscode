export const dict = {
  ...
  "desktop.updater.none.message": "Kasutate juba rakenduse VPS Code uusimat versiooni",
  ...
  "desktop.updater.downloaded.prompt":
    "VPS Code'i versioon {{version}} on alla laaditud. Kas soovite selle installida ja rakenduse taaskäivitada?",
