export const dict = {
  ...
  "desktop.updater.none.message": "Ja utilitzeu la versió més recent d'VPS Code",
  ...
  "desktop.updater.downloaded.prompt":
    "S'ha baixat la versió {{version}} d'VPS Code. Voleu instal·lar-la i reiniciar l'aplicació?",
