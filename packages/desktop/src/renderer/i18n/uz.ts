export const dict = {
  ...
  "desktop.updater.none.message": "Siz allaqachon VPS Code ning oxirgi versiyasidan foydalanyapsiz",
  ...
  "desktop.updater.downloaded.prompt":
    "VPS Codening {{version}} versiyasi yuklab olindi, uni oʻrnatib, qayta ishga tushirmoqchimisiz?",
