export const dict = {
  ...
  "desktop.updater.none.message": "Je gebruikt al de nieuwste versie van VPS Code",
  ...
  "desktop.updater.downloaded.prompt":
    "Versie {{version}} van VPS Code is gedownload. Wil je deze installeren en VPS Code opnieuw starten?",
