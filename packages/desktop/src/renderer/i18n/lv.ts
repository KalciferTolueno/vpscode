export const dict = {
  ...
  "desktop.updater.none.message": "Jūs jau izmantojat jaunāko VPS Code versiju",
  ...
  "desktop.updater.downloaded.prompt":
    "VPS Code versija {{version}} ir lejupielādēta. Vai vēlaties to instalēt un palaist no jauna?",
