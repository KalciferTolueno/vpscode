export const dict = {
  ...
  "desktop.updater.none.message": "თქვენ უკვე იყენებთ VPS Code-ის უახლეს ვერსიას",
  ...
  "desktop.updater.downloaded.prompt":
    "VPS Code-ის {{version}} ვერსია ჩამოტვირთულია, გსურთ მისი ინსტალაცია და ხელახლა გაშვება?",
