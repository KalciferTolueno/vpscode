export const dict = {
  ...
  "desktop.updater.none.message": "Že uporabljate najnovejšo različico VPS Code",
  ...
  "desktop.updater.downloaded.prompt":
    "Različica {{version}} VPS Code je bila prenesena, jo želite namestiti in znova zagnati?",
