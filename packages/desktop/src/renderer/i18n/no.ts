export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av VPS Code",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av VPS Code er lastet ned. Vil du installere den og starte på nytt?",
