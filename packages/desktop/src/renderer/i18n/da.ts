export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af VPS Code",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af VPS Code er blevet downloadet. Vil du installere den og genstarte?",
