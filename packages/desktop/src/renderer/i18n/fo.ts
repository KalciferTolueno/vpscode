export const dict = {
  ...
  "desktop.updater.none.message": "Tú brúkar longu nýggjastu útgávuna av VPS Code.",
  ...
  "desktop.updater.downloaded.prompt":
    "Útgáva {{version}} av VPS Code er heintað, vilt tú seta hana upp og seta hana í gongd aftur?",
