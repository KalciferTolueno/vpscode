export const dict = {
  ...
  "desktop.updater.none.message": "አሁን የቅርብ ጊዜውን የVPS Code ስሪት እየተጠቀሙ ነው",
  ...
  "desktop.updater.downloaded.prompt": "ስሪት {{version}} ከVPS Code ወርዷል፣ መጫን እና እንደገና ማስጀመር ይፈልጋሉ?",
