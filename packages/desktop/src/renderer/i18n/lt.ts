export const dict = {
  ...
  "desktop.updater.none.message": "Jau naudojate naujausią VPS Code versiją",
  ...
  "desktop.updater.downloaded.prompt":
    "VPS Code versija {{version}} atsisiųsta, ar norėtumėte ją įdiegti ir paleisti iš naujo?",
