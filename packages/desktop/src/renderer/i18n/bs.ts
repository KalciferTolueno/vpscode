export const dict = {
  ...
  "desktop.updater.none.message": "Već koristiš najnoviju verziju VPS Code-a",
  ...
  "desktop.updater.downloaded.prompt":
    "Verzija {{version}} VPS Code-a je preuzeta. Želiš li da je instaliraš i ponovo pokreneš aplikaciju?",
