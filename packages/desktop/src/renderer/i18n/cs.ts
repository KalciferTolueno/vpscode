export const dict = {
  ...
  "desktop.updater.none.message": "Již používáte nejnovější verzi VPS Code",
  ...
  "desktop.updater.downloaded.prompt":
    "Byla stažena verze {{version}} aplikace VPS Code. Chcete ji nainstalovat a aplikaci znovu spustit?",
