export const dict = {
  ...
  "desktop.updater.none.message": "Vous utilisez déjà la dernière version d'VPS Code",
  ...
  "desktop.updater.downloaded.prompt":
    "La version {{version}} d'VPS Code a été téléchargée. Voulez-vous l'installer et relancer l'application ?",
