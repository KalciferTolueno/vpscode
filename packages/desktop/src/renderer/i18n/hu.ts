export const dict = {
  ...
  "desktop.updater.none.message": "Már az VPS Code legújabb verzióját használja",
  ...
  "desktop.updater.downloaded.prompt":
    "Az VPS Code {{version}} verziója letöltődött. Szeretné telepíteni és újraindítani az alkalmazást?",
