export const dict = {
  ...
  "desktop.updater.none.message": "Anda sudah menggunakan versi terbaru VPS Code",
  ...
  "desktop.updater.downloaded.prompt":
    "VPS Code versi {{version}} telah diunduh. Apakah Anda ingin menginstalnya dan menjalankan ulang aplikasi?",
