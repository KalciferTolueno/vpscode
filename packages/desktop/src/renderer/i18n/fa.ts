export const dict = {
  ...
  "desktop.updater.none.message": "شما در حال حاضر از آخرین نسخه VPS Code استفاده می کنید",
  ...
  "desktop.updater.downloaded.prompt":
    "نسخه {{version}} VPS Code دانلود شده است، آیا می خواهید آن را نصب کنید و دوباره راه اندازی کنید؟",
