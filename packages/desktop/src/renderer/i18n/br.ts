export const dict = {
  ...
  "desktop.updater.none.message": "Você já está usando a versão mais recente do VPS Code",
  ...
  "desktop.updater.downloaded.prompt":
    "A versão {{version}} do VPS Code foi baixada. Você gostaria de instalá-la e reiniciar?",
