export const dict = {
  ...
  "desktop.updater.none.message": "Anda sudah menggunakan versi terkini VPS Code",
  ...
  "desktop.updater.downloaded.prompt":
    "Versi {{version}} VPS Code telah dimuat turun, adakah anda ingin memasangnya dan melancarkan semula?",
