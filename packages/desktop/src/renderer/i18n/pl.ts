export const dict = {
  ...
  "desktop.updater.none.message": "Korzystasz już z najnowszej wersji VPS Code",
  ...
  "desktop.updater.downloaded.prompt":
    "Pobrano wersję {{version}} VPS Code. Czy chcesz ją zainstalować i uruchomić ponownie?",
