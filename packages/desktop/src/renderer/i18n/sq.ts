export const dict = {
  ...
  "desktop.updater.none.message": "Ju tashmë po përdorni versionin më të fundit të VPS Code",
  ...
  "desktop.updater.downloaded.prompt":
    "Versioni {{version}} i VPS Code është shkarkuar, dëshironi ta instaloni dhe rinisni?",
