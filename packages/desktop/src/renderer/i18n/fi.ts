export const dict = {
  ...
  "desktop.updater.none.message": "Käytät jo VPS Coden uusinta versiota",
  ...
  "desktop.updater.downloaded.prompt":
    "VPS Coden versio {{version}} on ladattu. Haluatko asentaa sen ja käynnistää VPS Coden uudelleen?",
