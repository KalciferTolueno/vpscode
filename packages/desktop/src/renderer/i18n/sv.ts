export const dict = {
  ...
  "desktop.updater.none.message": "Du använder redan den senaste versionen av VPS Code",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} av VPS Code har laddats ned. Vill du installera den och starta om programmet?",
