export const dict = {
  ...
  "desktop.updater.none.message": "You are already using the latest version of VPS Code",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} of VPS Code has been downloaded, would you like to install it and relaunch?",
