export const dict = {
  ...
  "desktop.updater.none.message": "Sie verwenden bereits die neueste Version von VPS Code",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} von VPS Code wurde heruntergeladen. Möchten Sie sie installieren und neu starten?",
