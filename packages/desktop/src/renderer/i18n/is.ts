export const dict = {
  ...
  "desktop.updater.none.message": "Þú ert nú þegar að nota nýjustu útgáfuna af VPS Code",
  ...
  "desktop.updater.downloaded.prompt":
    "Útgáfu {{version}} af VPS Code hefur verið hlaðið niður. Viltu setja hana upp og endurræsa?",
