  ...
  return (
    <div class={`relative size-full flex flex-col gap-0 ${props.class ?? ""}`}>
      ...
      <form
        ...
        class="group/prompt-input relative min-h-[96px] w-full overflow-clip rounded-[3px] bg-v2-background-bg-deep"
        classList={{
      ...
      >
        <Show when={state.drag === "active"}>
          <div class="pointer-events-none absolute inset-0 z-20 grid place-items-center rounded-[3px] bg-v2-background-bg-deep/90 text-v2-text-text-base">
                ...
                <TooltipV2 value={attachment.filename} placement="top" contentClass="break-all">
                  ...
                  >
                    <img
                      ...
                      class="w-[58px] h-[46px] rounded-[3px] object-cover"
                      onClick={() => props.onAttachmentClick?.(attachment)}
                    />
                    <div class="absolute inset-0 rounded-[3px] shadow-[inset_0_0_0_0.5px_var(--v2-border-border-base)] pointer-events-none" />
                  </Show>
                </TooltipV2>
                <button
                  type="button"
