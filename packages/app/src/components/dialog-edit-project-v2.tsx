          ...
          <div class="flex w-full flex-col gap-2">
            ...
            <div class="flex items-center gap-3">
              <button
                ...
                class="relative size-16 shrink-0 cursor-pointer overflow-hidden rounded-[3px] outline outline-1 outline-transparent transition-[background-color,outline-color] focus-visible:outline-v2-border-border-focus"
                classList={{
              ...
              >
                <ProjectAvatar
                  ...
                  class="!size-16 [&_[data-slot=project-avatar-surface]]:!rounded-[3px] [&_[data-slot=project-avatar-surface]]:!text-[32px]"
                />
                <span
                  class="pointer-events-none absolute inset-0 flex items-center justify-center rounded-[3px] bg-v2-background-bg-contrast/80 text-v2-icon-icon-contrast backdrop-blur-[2px] transition-opacity"
                  classList={{
                ...
                <For each={PROJECT_AVATAR_VARIANTS}>
                  {(color) => (
                    <button
                      ...
                      class="flex size-8 items-center justify-center rounded-[3px] p-1 outline outline-1 outline-transparent transition-[background-color,outline-color] hover:bg-v2-overlay-simple-overlay-hover focus-visible:outline-v2-border-border-focus"
                      classList={{
                    ...
                    >
                      <ProjectAvatar
                        ...
                        class="!size-6 [&_[data-slot=project-avatar-surface]]:!rounded-[3px]"
                      />
                    </button>
                  )}
                </For>
