          ...
          <div class="flex flex-col gap-2">
            ...
            <div class="flex gap-3 items-start">
              ...
              >
                ...
                <div
                  class="absolute inset-0 size-16 bg-surface-raised-stronger-non-alpha/90 rounded-[3px] z-10 pointer-events-none flex items-center justify-center transition-opacity"
                  classList={{
