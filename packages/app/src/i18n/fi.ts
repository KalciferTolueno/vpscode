export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "VPS Coden tarjoamat ilmaiset mallit",
  ...
  "provider.connect.apiKey.description":
    "Anna {{provider}}-API-avaimesi yhdistääksesi tilisi ja käyttääksesi {{provider}}-malleja VPS Codessa.",
  ...
  "provider.connect.opencodeZen.line1":
    "VPS Code Zen antaa sinulle pääsyn kuratoituun joukkoon luotettavia optimoituja malleja koodausagenteille.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " ja hae valtuutuskoodi, jolla voit yhdistää tilisi ja käyttää {{provider}}-malleja VPS Codessa.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " ja anna alla oleva koodi yhdistääksesi tilisi ja käyttääksesi {{provider}}-malleja VPS Codessa.",
  ...
  "dialog.server.description": "Vaihda VPS Code-palvelimeen, johon tämä sovellus muodostaa yhteyden.",
  ...
  "wsl.onboarding.checkingOpencode": "Tarkistetaan VPS Codea...",
  "wsl.onboarding.checkingOpencodeIn": "Tarkistetaan VPS Codea kohteessa {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Päivitetään VPS Codea...",
  "wsl.onboarding.updatingOpencodeIn": "Päivitetään VPS Codea kohteessa {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Päivitä VPS Code jakelussa {{distro}}.",
  "wsl.onboarding.updateOpencode": "Päivitä VPS Code",
  "wsl.onboarding.opencodeReadyIn": "VPS Code on valmis jakelussa {{distro}}.",
  "wsl.onboarding.opencodeReady": "VPS Code on valmis.",
  "wsl.onboarding.installOpencodeIn": "Asenna VPS Code jakeluun {{distro}}.",
  "wsl.onboarding.installOpencode": "Asenna VPS Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "VPS Codea ei ole asennettu",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) vaaditaan ennen kuin VPS Code voi lisätä WSL-palvelimen",
  "wsl.onboarding.wslUnavailable.title": "WSL ei ole käytettävissä",
  "wsl.onboarding.wslUnavailable.description": "VPS Code ei voinut vahvistaa WSL:ää tällä koneella.",
  "wsl.onboarding.installWsl": "Asenna WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Viimeistele WSL:n asennus käynnistämällä Windows uudelleen ja avaa sitten VPS Code uudelleen.",
  ...
  "toast.update.description": "VPS Coden uusi versio ({{version}}) on nyt saatavana asennettavaksi.",
  ...
  "error.page.report.prefix": "Ilmoita tästä virheestä VPS Code-tiimille",
  ...
  "error.chain.mcpFailed": 'MCP-palvelin "{{name}}" epäonnistui. Huomaa, että VPS Code ei vielä tue MCP-todennusta.',
  ...
  "sidebar.gettingStarted.line1": "VPS Code sisältää ilmaisia malleja, joten voit aloittaa heti.",
  ...
  "settings.desktop.wsl.description": "Suorita VPS Code-palvelin WSL:n sisällä Windowsissa.",
  ...
  "settings.general.row.language.description": "Vaihda VPS Coden näyttökieli",
  ...
  "settings.general.row.appearance.description": "Mukauta, miltä VPS Code näyttää laitteellasi",
  "settings.general.row.colorScheme.title": "Värimalli",
  "settings.general.row.colorScheme.description":
    "Valitse, käyttääkö VPS Code järjestelmän mukaista, vaaleaa vai tummaa teemaa",
  "settings.general.row.theme.title": "Teema",
  "settings.general.row.theme.description": "Mukauta VPS Coden teemaa.",
  ...
  "settings.updates.row.startup.description": "Tarkista päivitykset automaattisesti, kun VPS Code käynnistyy",
  ...
  "settings.updates.toast.latest.description": "Käytät VPS Coden uusinta versiota.",
  ...
  "desktop.menu.documentation": "VPS Code-dokumentaatio",
  ...
  "desktop.menu.ariaLabel": "VPS Code-valikko",
  ...
  "desktop.recovery.loadFailed": "VPS Coden lataaminen epäonnistui",
  "desktop.recovery.terminated": "VPS Code-ikkuna sulkeutui odottamatta",
  "desktop.recovery.unresponsive": "VPS Code ei vastaa",
  ...
  "desktop.wsl.error.installOpencode": "VPS Coden asennus epäonnistui",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "VPS Codea ei ole asennettu jakeluun {{distro}}",
  "desktop.wsl.error.updateVersion":
    "VPS Coden päivitys valmistui, mutta {{distro}} ilmoittaa yhä version {{installed}}; odotettu versio on {{expected}}",
  ...
  "help.tabs.introduction": "VPS Code Desktop perustuu nyt välilehtiin.",
  "help.tabs.sessions":
