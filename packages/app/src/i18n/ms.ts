export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentasi VPS Code",
  ...
  "desktop.recovery.loadFailed": "VPS Code gagal dimuatkan",
  "desktop.recovery.terminated": "Tetingkap VPS Code ditamatkan secara tidak dijangka",
  "desktop.recovery.unresponsive": "VPS Code tidak memberi respons",
  ...
  "desktop.wsl.error.installOpencode": "Pemasangan VPS Code gagal",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "VPS Code tidak dipasang dalam {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Kemas kini VPS Code selesai tetapi {{distro}} masih melaporkan {{installed}}; sepatutnya {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Model percuma yang disediakan oleh VPS Code",
  ...
  "provider.connect.apiKey.description":
    "Masukkan kunci API {{provider}} anda untuk menghubungkan akaun anda dan menggunakan model {{provider}} dalam VPS Code.",
  ...
  "provider.connect.opencodeZen.line1":
    "VPS Code Zen memberi anda akses kepada set model terpilih yang boleh dipercayai dan dioptimumkan untuk ejen pengekodan.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " untuk mendapatkan kod kebenaran anda bagi menghubungkan akaun dan menggunakan model {{provider}} dalam VPS Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dan masukkan kod di bawah untuk menghubungkan akaun anda dan menggunakan model {{provider}} dalam VPS Code.",
  ...
  "dialog.server.description": "Tukar pelayan VPS Code yang disambungkan oleh aplikasi ini.",
  ...
  "wsl.onboarding.checkingOpencode": "Sedang menyemak VPS Code...",
  "wsl.onboarding.checkingOpencodeIn": "Sedang menyemak VPS Code dalam {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Sedang mengemas kini VPS Code...",
  "wsl.onboarding.updatingOpencodeIn": "Sedang mengemas kini VPS Code dalam {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Kemas kini VPS Code dalam {{distro}}.",
  "wsl.onboarding.updateOpencode": "Kemas kini VPS Code",
  "wsl.onboarding.opencodeReadyIn": "VPS Code sedia digunakan dalam {{distro}}.",
  "wsl.onboarding.opencodeReady": "VPS Code sedia digunakan.",
  "wsl.onboarding.installOpencodeIn": "Pasang VPS Code dalam {{distro}}.",
  "wsl.onboarding.installOpencode": "Pasang VPS Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "VPS Code belum dipasang",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) diperlukan sebelum VPS Code boleh menambah pelayan WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL tidak tersedia",
  "wsl.onboarding.wslUnavailable.description": "VPS Code tidak dapat mengesahkan WSL pada mesin ini.",
  "wsl.onboarding.installWsl": "Pasang WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Mulakan semula Windows untuk menyiapkan pemasangan WSL, kemudian buka semula VPS Code.",
  ...
  "help.tabs.introduction": "VPS Code Desktop kini dibina berasaskan tab.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Versi baharu VPS Code ({{version}}) kini tersedia untuk dipasang.",
  ...
  "error.page.report.prefix": "Sila laporkan ralat ini kepada pasukan VPS Code",
  ...
  "error.chain.mcpFailed": 'Pelayan MCP "{{name}}" gagal. Nota, VPS Code belum menyokong pengesahan MCP.',
  ...
  "sidebar.gettingStarted.line1": "VPS Code merangkumi model percuma supaya anda boleh bermula serta-merta.",
  ...
  "settings.desktop.wsl.description": "Jalankan pelayan VPS Code dalam WSL di Windows.",
  ...
  "settings.general.row.language.description": "Tukar bahasa paparan untuk VPS Code",
  ...
  "settings.general.row.appearance.description": "Sesuaikan rupa VPS Code pada peranti anda",
  "settings.general.row.colorScheme.title": "Skema warna",
  "settings.general.row.colorScheme.description": "Pilih sama ada VPS Code mengikut sistem, tema cerah, atau gelap",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Sesuaikan tema VPS Code.",
  ...
  "settings.updates.row.startup.description": "Semak kemas kini secara automatik apabila VPS Code dilancarkan",
  ...
  "settings.updates.toast.latest.description": "Anda sedang menggunakan versi terkini VPS Code.",
