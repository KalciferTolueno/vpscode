export const dict = {
  ...
  "desktop.menu.documentation": "VPS Code Dokumentacija",
  ...
  "desktop.recovery.loadFailed": "VPS Code ni uspelo naložiti",
  "desktop.recovery.terminated": "Okno VPS Code se je nepričakovano končalo",
  "desktop.recovery.unresponsive": "VPS Code se ne odziva",
  ...
  "desktop.wsl.error.installOpencode": "Namestitev VPS Code ni uspela",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "VPS Code ni nameščen v {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Posodobitev VPS Code je končana, vendar {{distro}} še vedno poroča {{installed}}; pričakovano {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Brezplačne modele ponuja VPS Code",
  ...
  "provider.connect.apiKey.description":
    "Vnesite ključ API ponudnika {{provider}}, da povežete račun in uporabljate modele {{provider}} v VPS Code.",
  ...
  "provider.connect.opencodeZen.line1":
    "VPS Code Zen vam omogoča dostop do izbranega nabora zanesljivih optimiziranih modelov za agente za kodiranje.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " za zbiranje avtorizacijske kode za povezavo vašega računa in uporabo modelov {{provider}} v VPS Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " in vnesite spodnjo kodo, da povežete svoj račun in uporabite modele {{provider}} v VPS Code.",
  ...
  "dialog.server.description": "Preklopite, s katerim strežnikom VPS Code se povezuje ta aplikacija.",
  ...
  "wsl.onboarding.checkingOpencode": "Preverjanje VPS Code ...",
  "wsl.onboarding.checkingOpencodeIn": "Preverjanje VPS Code v {{distro}} ...",
  "wsl.onboarding.updatingOpencode": "Posodabljanje VPS Code ...",
  "wsl.onboarding.updatingOpencodeIn": "Posodabljanje VPS Code v {{distro}} ...",
  "wsl.onboarding.updateOpencodeIn": "Posodobite VPS Code v {{distro}}.",
  "wsl.onboarding.updateOpencode": "Posodobite VPS Code",
  "wsl.onboarding.opencodeReadyIn": "VPS Code je pripravljen v {{distro}}.",
  "wsl.onboarding.opencodeReady": "VPS Code je pripravljen.",
  "wsl.onboarding.installOpencodeIn": "Namestite VPS Code v {{distro}}.",
  "wsl.onboarding.installOpencode": "Namestite VPS Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "VPS Code ni nameščen",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (podsistem Windows za Linux) je potreben, preden lahko VPS Code doda strežnik WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL ni na voljo",
  "wsl.onboarding.wslUnavailable.description": "VPS Code ni mogel preveriti WSL na tej napravi.",
  "wsl.onboarding.installWsl": "Namestite WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Znova zaženite Windows, da dokončate namestitev WSL, nato znova odprite VPS Code.",
  ...
  "help.tabs.introduction": "VPS Code Desktop je zdaj zgrajen okoli zavihkov.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova različica VPS Code ({{version}}) je zdaj na voljo za namestitev.",
  ...
  "error.page.report.prefix": "Prosimo, prijavite to napako ekipi VPS Code",
  ...
  "error.chain.mcpFailed": 'MCP strežnik "{{name}}" ni uspel. Opomba, VPS Code še ne podpira avtentikacije MCP.',
  ...
  "sidebar.gettingStarted.line1": "VPS Code vključuje brezplačne modele, tako da lahko začnete takoj.",
  ...
  "settings.desktop.wsl.description": "Zaženite strežnik VPS Code znotraj WSL na Windows.",
  ...
  "settings.general.row.language.description": "Spremenite jezik prikaza za VPS Code",
  ...
  "settings.general.row.appearance.description": "Prilagodite, kako VPS Code izgleda na vaši napravi",
  "settings.general.row.colorScheme.title": "Barvna shema",
  "settings.general.row.colorScheme.description": "Izberite, ali VPS Code sledi sistemski, svetli ali temni temi",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodite temo VPS Code.",
  ...
  "settings.updates.row.startup.description": "Samodejno preveri posodobitve, ko se zažene VPS Code",
  ...
  "settings.updates.toast.latest.description": "Uporabljate najnovejšo različico VPS Code.",
