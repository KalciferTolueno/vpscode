export const dict = {
  ...
  "desktop.menu.documentation": "VPS Code-documentatie",
  ...
  "desktop.recovery.loadFailed": "VPS Code kan niet worden geladen",
  "desktop.recovery.terminated": "Het VPS Code-venster is onverwacht beëindigd",
  "desktop.recovery.unresponsive": "VPS Code reageert niet",
  ...
  "desktop.wsl.error.installOpencode": "Installatie van VPS Code is mislukt",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "VPS Code is niet geïnstalleerd in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "De VPS Code-update is voltooid, maar {{distro}} meldt nog steeds {{installed}}; verwacht: {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modellen geleverd door VPS Code",
  ...
  "provider.connect.apiKey.description":
    "Voer je {{provider}}-API-sleutel in om je account te koppelen en {{provider}}-modellen in VPS Code te gebruiken.",
  ...
  "provider.connect.opencodeZen.line1":
    "VPS Code Zen geeft je toegang tot een samengestelde set betrouwbare, geoptimaliseerde modellen voor codeeragenten.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " om je autorisatiecode op te halen, je account te koppelen en {{provider}}-modellen in VPS Code te gebruiken.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " en voer de onderstaande code in om je account te koppelen en {{provider}}-modellen in VPS Code te gebruiken.",
  ...
  "dialog.server.description": "Wijzig met welke VPS Code-server deze app verbinding maakt.",
  ...
  "wsl.onboarding.checkingOpencode": "VPS Code controleren...",
  "wsl.onboarding.checkingOpencodeIn": "VPS Code controleren in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "VPS Code bijwerken...",
  "wsl.onboarding.updatingOpencodeIn": "VPS Code bijwerken in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Werk VPS Code bij in {{distro}}.",
  "wsl.onboarding.updateOpencode": "VPS Code bijwerken",
  "wsl.onboarding.opencodeReadyIn": "VPS Code is gereed in {{distro}}.",
  "wsl.onboarding.opencodeReady": "VPS Code is klaar.",
  "wsl.onboarding.installOpencodeIn": "Installeer VPS Code in {{distro}}.",
  "wsl.onboarding.installOpencode": "Installeer VPS Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "VPS Code niet geïnstalleerd",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows-subsysteem voor Linux) is vereist voordat VPS Code een WSL-server kan toevoegen",
  "wsl.onboarding.wslUnavailable.title": "WSL niet beschikbaar",
  "wsl.onboarding.wslUnavailable.description": "VPS Code kan WSL niet verifiëren op deze machine.",
  "wsl.onboarding.installWsl": "Installeer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows opnieuw om de installatie van WSL te voltooien en open vervolgens VPS Code opnieuw.",
  ...
  "help.tabs.introduction": "VPS Code Desktop is nu opgebouwd rond tabbladen.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Er is nu een nieuwe versie van VPS Code ({{version}}) beschikbaar om te installeren.",
  ...
  "error.page.report.prefix": "Rapporteer deze fout aan het VPS Code-team",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" is mislukt. Let op: VPS Code ondersteunt nog geen MCP-authenticatie.',
  ...
  "sidebar.gettingStarted.line1": "VPS Code bevat gratis modellen, zodat je direct aan de slag kunt.",
  ...
  "settings.desktop.wsl.description": "Voer de VPS Code-server uit in WSL op Windows.",
  ...
  "settings.general.row.language.description": "Wijzig de weergavetaal voor VPS Code",
  ...
  "settings.general.row.appearance.description": "Pas aan hoe VPS Code eruitziet op je apparaat",
  "settings.general.row.colorScheme.title": "Kleurenschema",
  "settings.general.row.colorScheme.description":
    "Kies of VPS Code het systeemthema, het lichte thema of het donkere thema gebruikt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Pas het thema van VPS Code aan.",
  ...
  "settings.updates.row.startup.description": "Controleer automatisch op updates wanneer VPS Code wordt gestart",
  ...
  "settings.updates.toast.latest.title": "VPS Code is bijgewerkt",
  "settings.updates.toast.latest.description": "Je gebruikt de nieuwste versie van VPS Code.",
