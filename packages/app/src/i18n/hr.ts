...
const desktop = [
  ...
  "Nastavi čekati",
  "Izađi",
  "VPS Code se nije uspio učitati",
  "Prozor aplikacije VPS Code neočekivano je zatvoren",
  "VPS Code ne reagira",
  ...
  "Instalacija aplikacije VPS Code nije uspjela",
  ...
  "VPS Code nije instaliran u distribuciji {{distro}}",
  "Ažuriranje aplikacije VPS Code je završeno, ali {{distro}} i dalje prijavljuje {{installed}}; očekivano je {{expected}}",
  "nema verzije",
...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatne modele nudi VPS Code",
  ...
  "provider.connect.apiKey.description":
    "Enter vaš {{provider}} API ključ za povezivanje vašeg računa i korištenje {{provider}} modela u VPS Code.",
  ...
  "provider.connect.opencodeZen.line1":
    "VPS Code Zen vam daje pristup odabranom skupu pouzdanih optimiziranih modela za agente za kodiranje.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "za prikupljanje vašeg autorizacijskog koda za povezivanje vašeg računa i korištenje {{provider}} modela u VPS Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "i unesite kod ispod kako biste povezali svoj račun i koristili {{provider}} modele u VPS Code.",
  ...
  "dialog.server.description": "Promijenite na koji se VPS Code poslužitelj povezuje ova aplikacija.",
  ...
  "wsl.onboarding.checkingOpencodeIn": "Provjera VPS Code u {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Ažuriranje VPS Code...",
  "wsl.onboarding.updatingOpencodeIn": "Ažuriranje VPS Code u {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Ažurirajte VPS Code u {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ažurirajte VPS Code",
  "wsl.onboarding.opencodeReadyIn": "VPS Code je spreman u {{distro}}.",
  "wsl.onboarding.opencodeReady": "VPS Code je spreman.",
  "wsl.onboarding.installOpencodeIn": "Instalirajte VPS Code u {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalirajte VPS Code",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows podsustav za Linux) je potreban prije nego što VPS Code može dodati WSL poslužitelj",
  "wsl.onboarding.wslUnavailable.title": "WSL nedostupan",
  "wsl.onboarding.wslUnavailable.description": "VPS Code nije mogao potvrditi WSL na ovom stroju.",
  "wsl.onboarding.installWsl": "Instalirajte WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokrenite Windows da dovršite instalaciju WSL, zatim ponovno otvorite VPS Code.",
  ...
  "help.tabs.introduction": "Radna površina VPS Code sada je izgrađena oko kartica.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova verzija VPS Code ({{version}}) sada je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Prijavite ovu grešku VPS Code timu",
  ...
  "error.chain.mcpFailed":
    'MCP poslužitelj "{{name}}" nije uspio. Napomena, VPS Code još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "VPS Code uključuje besplatne modele tako da možete odmah početi.",
  ...
  "app.name.desktop": "VPS Code Radna površina",
  ...
  "settings.desktop.wsl.description": "Pokrenite VPS Code poslužitelj unutar WSL na Windows.",
  ...
  "settings.general.row.language.description": "Promijenite jezik prikaza za VPS Code",
  ...
  "settings.general.row.appearance.description": "Prilagodite kako VPS Code izgleda na vašem uređaju",
  "settings.general.row.colorScheme.title": "Shema boja",
  "settings.general.row.colorScheme.description":
    "Odaberite hoće li VPS Code slijediti sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodite način na koji je VPS Code tematiziran.",
  ...
  "settings.updates.row.startup.description": "Automatski provjeri ima li ažuriranja kada se VPS Code pokrene",
  ...
  "settings.updates.toast.latest.description": "Imate najnoviju verziju VPS Code.",
