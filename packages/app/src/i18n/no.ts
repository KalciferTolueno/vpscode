...
export const dict = {
  ...
  "desktop.menu.documentation": "VPS Code-dokumentasjon",
  ...
  "desktop.menu.ariaLabel": "VPS Code-meny",
  ...
  "desktop.recovery.loadFailed": "VPS Code kunne ikke lastes inn",
  "desktop.recovery.terminated": "VPS Code-vinduet ble uventet avsluttet",
  "desktop.recovery.unresponsive": "VPS Code svarer ikke",
  ...
  "desktop.wsl.error.installOpencode": "Installasjonen av VPS Code mislyktes",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "VPS Code er ikke installert i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Oppdateringen av VPS Code er fullført, men {{distro}} rapporterer fortsatt {{installed}}; forventet {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av VPS Code",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn API-nøkkelen din for {{provider}} for å koble til kontoen din og bruke {{provider}}-modeller i VPS Code.",
  ...
  "provider.connect.opencodeZen.line1":
    "VPS Code Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i VPS Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i VPS Code.",
  ...
  "dialog.server.description": "Bytt hvilken VPS Code-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av VPS Code ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til VPS Code-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at VPS Code ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "VPS Code inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør VPS Code-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for VPS Code",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan VPS Code ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description":
    "Velg om VPS Code skal følge systeminnstillingen eller bruke lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass temaet i VPS Code.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når VPS Code starter",
  ...
  "settings.updates.toast.latest.title": "VPS Code er oppdatert",
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av VPS Code.",
  ...
  "wsl.onboarding.checkingOpencode": "Sjekker VPS Code...",
  "wsl.onboarding.checkingOpencodeIn": "Sjekker VPS Code i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Oppdaterer VPS Code...",
  "wsl.onboarding.updatingOpencodeIn": "Oppdaterer VPS Code i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Oppdater VPS Code i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Oppdater VPS Code",
  "wsl.onboarding.opencodeReadyIn": "VPS Code er klar i {{distro}}.",
  "wsl.onboarding.opencodeReady": "VPS Code er klar.",
  "wsl.onboarding.installOpencodeIn": "Installer VPS Code i {{distro}}.",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "VPS Code er ikke installert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) kreves før VPS Code kan legge til en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er utilgjengelig",
  "wsl.onboarding.wslUnavailable.description": "VPS Code kunne ikke bekrefte WSL på denne maskinen.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows på nytt for å fullføre installasjonen av WSL, og åpne deretter VPS Code på nytt.",
  ...
  "help.tabs.introduction": "VPS Code Desktop er nå bygget rundt faner.",
  "help.tabs.sessions":
