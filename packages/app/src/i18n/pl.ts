export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacja VPS Code",
  ...
  "desktop.recovery.loadFailed": "Nie udało się wczytać VPS Code",
  "desktop.recovery.terminated": "Okno VPS Code zostało nieoczekiwanie zamknięte",
  "desktop.recovery.unresponsive": "VPS Code nie odpowiada",
  ...
  "desktop.wsl.error.installOpencode": "Nie udało się zainstalować VPS Code",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "VPS Code nie jest zainstalowany w dystrybucji {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Aktualizacja VPS Code została ukończona, ale dystrybucja {{distro}} nadal zgłasza wersję {{installed}}; oczekiwano {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez VPS Code",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w VPS Code.",
  ...
  "provider.connect.opencodeZen.line1":
    "VPS Code Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów programistycznych.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w VPS Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w VPS Code.",
  ...
  "dialog.server.description": "Przełącz serwer VPS Code, z którym łączy się ta aplikacja.",
  ...
  "wsl.onboarding.checkingOpencode": "Sprawdzanie VPS Code...",
  "wsl.onboarding.checkingOpencodeIn": "Sprawdzanie VPS Code w dystrybucji {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Aktualizowanie VPS Code...",
  "wsl.onboarding.updatingOpencodeIn": "Aktualizowanie VPS Code w dystrybucji {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Zaktualizuj VPS Code w dystrybucji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Zaktualizuj VPS Code",
  "wsl.onboarding.opencodeReadyIn": "VPS Code jest gotowy w dystrybucji {{distro}}.",
  "wsl.onboarding.opencodeReady": "VPS Code jest gotowy.",
  "wsl.onboarding.installOpencodeIn": "Zainstaluj VPS Code w dystrybucji {{distro}}.",
  "wsl.onboarding.installOpencode": "Zainstaluj VPS Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "VPS Code nie jest zainstalowany",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Podsystem Windows dla systemu Linux) jest wymagany, zanim VPS Code będzie mógł dodać serwer WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL jest niedostępny",
  "wsl.onboarding.wslUnavailable.description": "VPS Code nie mógł zweryfikować WSL na tym komputerze.",
  "wsl.onboarding.installWsl": "Zainstaluj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Uruchom ponownie system Windows, aby dokończyć instalację WSL, a następnie ponownie otwórz VPS Code.",
  ...
  "help.tabs.introduction": "VPS Code Desktop korzysta teraz z układu opartego na kartach.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nowa wersja VPS Code ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu VPS Code",
  ...
  "error.chain.mcpFailed":
    "Serwer MCP „{{name}}” nie uruchomił się. Uwaga: VPS Code nie obsługuje jeszcze uwierzytelniania MCP.",
  ...
  "sidebar.gettingStarted.line1": "VPS Code zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.desktop.wsl.description": "Uruchamiaj serwer VPS Code wewnątrz WSL w systemie Windows.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla VPS Code",
  ...
  "settings.general.row.appearance.description": "Dostosuj wygląd VPS Code na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy VPS Code ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw VPS Code.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania VPS Code",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji VPS Code.",
