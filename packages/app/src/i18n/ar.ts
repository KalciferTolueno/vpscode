export const dict = {
  ...
  "desktop.recovery.loadFailed": "فشل تحميل VPS Code",
  "desktop.recovery.terminated": "توقفت نافذة VPS Code بشكل غير متوقع",
  "desktop.recovery.unresponsive": "VPS Code لا يستجيب",
  ...
  "desktop.wsl.error.installOpencode": "فشل تثبيت VPS Code",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "VPS Code غير مثبت في {{distro}}",
  "desktop.wsl.error.updateVersion":
    "اكتمل تحديث VPS Code، لكن {{distro}} ما زالت تعرض الإصدار {{installed}}؛ الإصدار المتوقع هو {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "نماذج مجانية مقدمة من VPS Code",
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح API الخاص بـ {{provider}} لتوصيل حسابك واستخدام نماذج {{provider}} في VPS Code.",
  ...
  "provider.connect.opencodeZen.line1":
    "يمنحك VPS Code Zen الوصول إلى مجموعة مختارة من النماذج الموثوقة والمحسنة لوكلاء البرمجة.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " للحصول على رمز التفويض الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في VPS Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " وأدخل الرمز أدناه لتوصيل حسابك واستخدام نماذج {{provider}} في VPS Code.",
  ...
  "dialog.server.description": "تبديل خادم VPS Code الذي يتصل به هذا التطبيق.",
  ...
  "wsl.onboarding.checkingOpencode": "جارٍ التحقق من VPS Code...",
  "wsl.onboarding.checkingOpencodeIn": "جارٍ التحقق من VPS Code في {{distro}}...",
  "wsl.onboarding.updatingOpencode": "جارٍ تحديث VPS Code...",
  "wsl.onboarding.updatingOpencodeIn": "جارٍ تحديث VPS Code في {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "حدّث VPS Code في {{distro}}.",
  "wsl.onboarding.updateOpencode": "تحديث VPS Code",
  "wsl.onboarding.opencodeReadyIn": "VPS Code جاهز في {{distro}}.",
  "wsl.onboarding.opencodeReady": "VPS Code جاهز.",
  "wsl.onboarding.installOpencodeIn": "ثبّت VPS Code في {{distro}}.",
  "wsl.onboarding.installOpencode": "تثبيت VPS Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "VPS Code غير مثبت",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "يلزم WSL (نظام Windows الفرعي لـ Linux) قبل أن يتمكن VPS Code من إضافة خادم WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL غير متاح",
  "wsl.onboarding.wslUnavailable.description": "تعذر على VPS Code التحقق من WSL على هذا الجهاز.",
  "wsl.onboarding.installWsl": "تثبيت WSL",
  "wsl.onboarding.windowsRestartRequired": "أعد تشغيل Windows لإكمال تثبيت WSL، ثم أعد فتح VPS Code.",
  ...
  "help.tabs.introduction": "أصبح VPS Code Desktop الآن قائمًا على علامات التبويب.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "يتوفر الآن إصدار جديد من VPS Code ({{version}}) للتثبيت.",
  ...
  "error.page.report.prefix": "يرجى الإبلاغ عن هذا الخطأ لفريق VPS Code",
  ...
  "error.chain.mcpFailed": 'فشل خادم MCP "{{name}}". لاحظ أن VPS Code لا يدعم مصادقة MCP بعد.',
  ...
  "sidebar.gettingStarted.line1": "يتضمن VPS Code نماذج مجانية حتى تتمكن من البدء فورًا.",
  ...
  "settings.desktop.wsl.description": "تشغيل خادم VPS Code داخل WSL على Windows.",
  ...
  "settings.general.row.language.description": "تغيير لغة العرض لـ VPS Code",
  ...
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور VPS Code على جهازك",
  "settings.general.row.colorScheme.title": "مخطط الألوان",
  "settings.general.row.colorScheme.description": "اختر ما إذا كان VPS Code يتبع سمة النظام أو الفاتح أو الداكن",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة VPS Code.",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل VPS Code",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من VPS Code.",
