export const dict = {
  ...
  "desktop.menu.documentation": "Documentation d'VPS Code",
  ...
  "desktop.recovery.loadFailed": "Échec du chargement d'VPS Code",
  "desktop.recovery.terminated": "La fenêtre VPS Code s'est arrêtée de manière inattendue",
  "desktop.recovery.unresponsive": "VPS Code ne répond pas",
  ...
  "desktop.wsl.error.installOpencode": "Échec de l'installation d'VPS Code",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "VPS Code n'est pas installé dans {{distro}}",
  "desktop.wsl.error.updateVersion":
    "La mise à jour d'VPS Code est terminée, mais {{distro}} indique toujours {{installed}} au lieu de {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par VPS Code",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans VPS Code.",
  ...
  "provider.connect.opencodeZen.line1":
    "VPS Code Zen vous donne accès à un ensemble sélectionné de modèles fiables et optimisés pour les agents de codage.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans VPS Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans VPS Code.",
  ...
  "dialog.server.description": "Changez le serveur VPS Code auquel cette application se connecte.",
  ...
  "wsl.onboarding.checkingOpencode": "Vérification d'VPS Code...",
  "wsl.onboarding.checkingOpencodeIn": "Vérification d'VPS Code dans {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Mise à jour d'VPS Code...",
  "wsl.onboarding.updatingOpencodeIn": "Mise à jour d'VPS Code dans {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Mettez à jour VPS Code dans {{distro}}.",
  "wsl.onboarding.updateOpencode": "Mettre à jour VPS Code",
  "wsl.onboarding.opencodeReadyIn": "VPS Code est prêt dans {{distro}}.",
  "wsl.onboarding.opencodeReady": "VPS Code est prêt.",
  "wsl.onboarding.installOpencodeIn": "Installez VPS Code dans {{distro}}.",
  "wsl.onboarding.installOpencode": "Installer VPS Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "VPS Code non installé",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) est requis avant qu'VPS Code puisse ajouter un serveur WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponible",
  "wsl.onboarding.wslUnavailable.description": "VPS Code n'a pas pu vérifier WSL sur cet appareil.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Redémarrez Windows pour terminer l'installation de WSL, puis rouvrez VPS Code.",
  ...
  "help.tabs.introduction": "VPS Code Desktop s'articule désormais autour d'onglets.",
  "help.tabs.sessions":
  ...
  "toast.update.description":
    "Une nouvelle version d'VPS Code ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe VPS Code",
  ...
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'VPS Code ne prend pas encore en charge l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "VPS Code inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur VPS Code dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour VPS Code",
  ...
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'VPS Code sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si VPS Code suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'VPS Code.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'VPS Code",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'VPS Code.",
