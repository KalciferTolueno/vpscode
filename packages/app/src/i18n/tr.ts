...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "VPS Code yüklenemedi",
  "desktop.recovery.terminated": "VPS Code penceresi beklenmedik şekilde sonlandırıldı",
  "desktop.recovery.unresponsive": "VPS Code yanıt vermiyor",
  ...
  "desktop.wsl.error.installOpencode": "VPS Code kurulamadı",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "VPS Code, {{distro}} içinde kurulu değil",
  "desktop.wsl.error.updateVersion":
    "VPS Code güncellemesi tamamlandı ancak {{distro}} hâlâ {{installed}} sürümünü bildiriyor; beklenen sürüm: {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "VPS Code tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve VPS Code'da {{provider}} modellerini kullanmak için API anahtarınızı girin.",
  ...
  "provider.connect.opencodeZen.line1":
    "VPS Code Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " gidin; ardından hesabınızı bağlayarak VPS Code'da {{provider}} modellerini kullanın.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak VPS Code'da {{provider}} modellerini kullanın.",
  ...
  "dialog.server.description": "Bu uygulamanın hangi VPS Code sunucusuna bağlanacağını değiştirin.",
  ...
  "wsl.onboarding.checkingOpencode": "VPS Code kontrol ediliyor...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} içinde VPS Code kontrol ediliyor...",
  "wsl.onboarding.updatingOpencode": "VPS Code güncelleniyor...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} içinde VPS Code güncelleniyor...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}} içindeki VPS Code'u güncelleyin.",
  "wsl.onboarding.updateOpencode": "VPS Code'u güncelle",
  "wsl.onboarding.opencodeReadyIn": "{{distro}} içinde VPS Code hazır.",
  "wsl.onboarding.opencodeReady": "VPS Code hazır.",
  "wsl.onboarding.installOpencodeIn": "VPS Code'u {{distro}} içine kurun.",
  "wsl.onboarding.installOpencode": "VPS Code'u kur",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "VPS Code kurulu değil",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "VPS Code'un WSL sunucusu ekleyebilmesi için önce WSL (Linux için Windows Alt Sistemi) kurulmalıdır",
  "wsl.onboarding.wslUnavailable.title": "WSL kullanılamıyor",
  "wsl.onboarding.wslUnavailable.description": "VPS Code bu makinede WSL'yi doğrulayamadı.",
  "wsl.onboarding.installWsl": "WSL'yi kur",
  "wsl.onboarding.windowsRestartRequired":
    "WSL kurulumunu tamamlamak için Windows'u yeniden başlatın, ardından VPS Code'u tekrar açın.",
  ...
  "help.tabs.introduction": "VPS Code Desktop artık sekmeler üzerine kurulu.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "VPS Code'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı VPS Code ekibine bildirin",
  ...
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" çalıştırılamadı. Not: VPS Code henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "VPS Code ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "VPS Code Masaüstü",
  ...
  "settings.desktop.wsl.description": "VPS Code sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "VPS Code'un görünüm dilini değiştirin",
  ...
  "settings.general.row.appearance.description": "VPS Code'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "VPS Code'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "VPS Code'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "VPS Code başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "VPS Code'un en son sürümünü kullanıyorsunuz.",
