...
export const DESKTOP_NATIVE_ENGLISH = {
  ...
  "desktop.recovery.loadFailed": "VPS Code failed to load",
  "desktop.recovery.terminated": "VPS Code window terminated unexpectedly",
  "desktop.recovery.unresponsive": "VPS Code is not responding",
  ...
  "desktop.wsl.error.installOpencode": "VPS Code installation failed",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "VPS Code is not installed in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "VPS Code update finished but {{distro}} still reports {{installed}}; expected {{expected}}",
