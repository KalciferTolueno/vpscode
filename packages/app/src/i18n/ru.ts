export const dict = {
  ...
  "desktop.menu.documentation": "Документация VPS Code",
  ...
  "desktop.recovery.loadFailed": "Не удалось загрузить VPS Code",
  "desktop.recovery.terminated": "Окно VPS Code неожиданно завершило работу",
  "desktop.recovery.unresponsive": "VPS Code не отвечает",
  ...
  "desktop.wsl.error.installOpencode": "Не удалось установить VPS Code",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "VPS Code не установлен в {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Обновление VPS Code завершено, но {{distro}} по-прежнему сообщает версию {{installed}}; ожидалась {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Бесплатные модели от VPS Code",
  ...
  "provider.connect.apiKey.description":
    "Введите ключ API {{provider}}, чтобы подключить аккаунт и использовать модели {{provider}} в VPS Code.",
  ...
  "provider.connect.opencodeZen.line1":
    "VPS Code Zen даёт вам доступ к отобранным надёжным оптимизированным моделям для агентов программирования.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " чтобы получить код авторизации для подключения аккаунта и использования моделей {{provider}} в VPS Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " и введите код ниже для подключения аккаунта и использования моделей {{provider}} в VPS Code.",
  ...
  "dialog.server.description": "Выберите сервер VPS Code, к которому подключается приложение.",
  ...
  "wsl.onboarding.checkingOpencode": "Проверка VPS Code...",
  "wsl.onboarding.checkingOpencodeIn": "Проверка VPS Code в {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Обновление VPS Code...",
  "wsl.onboarding.updatingOpencodeIn": "Обновление VPS Code в {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Обновите VPS Code в {{distro}}.",
  "wsl.onboarding.updateOpencode": "Обновить VPS Code",
  "wsl.onboarding.opencodeReadyIn": "VPS Code в {{distro}} готов к работе.",
  "wsl.onboarding.opencodeReady": "VPS Code готов к работе.",
  "wsl.onboarding.installOpencodeIn": "Установите VPS Code в {{distro}}.",
  "wsl.onboarding.installOpencode": "Установить VPS Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "VPS Code не установлен",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Для добавления сервера WSL в VPS Code требуется WSL (Подсистема Windows для Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL недоступна",
  "wsl.onboarding.wslUnavailable.description": "VPS Code не смог проверить WSL на этом компьютере.",
  "wsl.onboarding.installWsl": "Установить WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Перезапустите Windows, чтобы завершить установку WSL, затем снова откройте VPS Code.",
  ...
  "help.tabs.introduction": "Теперь работа в VPS Code Desktop организована с помощью вкладок.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Новая версия VPS Code ({{version}}) доступна для установки.",
  ...
  "error.page.report.prefix": "Пожалуйста, сообщите об этой ошибке команде VPS Code",
  ...
  "error.chain.mcpFailed":
    'MCP-сервер "{{name}}" завершился с ошибкой. Обратите внимание: VPS Code пока не поддерживает MCP-авторизацию.',
  ...
  "sidebar.gettingStarted.line1": "VPS Code включает бесплатные модели, чтобы вы могли начать сразу.",
  ...
  "settings.desktop.wsl.description": "Запускать сервер VPS Code внутри WSL на Windows.",
  ...
  "settings.general.row.language.description": "Изменить язык отображения VPS Code",
  ...
  "settings.general.row.appearance.description": "Настройте внешний вид VPS Code на вашем устройстве",
  "settings.general.row.colorScheme.title": "Цветовая схема",
  "settings.general.row.colorScheme.description": "Выберите, следует ли VPS Code системной, светлой или тёмной теме",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Настройте оформление VPS Code.",
  ...
  "settings.updates.row.startup.description": "Автоматически проверять обновления при запуске VPS Code",
  ...
  "settings.updates.toast.latest.description": "Вы используете последнюю версию VPS Code.",
