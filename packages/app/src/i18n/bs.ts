export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacija za VPS Code",
  ...
  "desktop.menu.ariaLabel": "VPS Code meni",
  ...
  "desktop.recovery.loadFailed": "VPS Code se nije uspio učitati",
  "desktop.recovery.terminated": "Prozor VPS Code-a neočekivano je zatvoren",
  "desktop.recovery.unresponsive": "VPS Code ne reaguje",
  ...
  "desktop.wsl.error.installOpencode": "Instalacija VPS Code-a nije uspjela",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "VPS Code nije instaliran u distribuciji {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Ažuriranje VPS Code-a je završeno, ali {{distro}} i dalje prijavljuje {{installed}}; očekivano je {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje VPS Code",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u VPS Code-u.",
  ...
  "provider.connect.opencodeZen.line1":
    "VPS Code Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u VPS Code-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u VPS Code-u.",
  ...
  "dialog.server.description": "Promijeni na koji se VPS Code server ova aplikacija povezuje.",
  ...
  "wsl.onboarding.checkingOpencode": "Provjera VPS Code...",
  "wsl.onboarding.checkingOpencodeIn": "Provjera VPS Code u distribuciji {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Ažuriranje VPS Code...",
  "wsl.onboarding.updatingOpencodeIn": "Ažuriranje VPS Code u distribuciji {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Ažuriraj VPS Code u distribuciji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ažuriraj VPS Code",
  "wsl.onboarding.opencodeReadyIn": "VPS Code je spreman u distribuciji {{distro}}.",
  "wsl.onboarding.opencodeReady": "VPS Code je spreman.",
  "wsl.onboarding.installOpencodeIn": "Instaliraj VPS Code u distribuciji {{distro}}.",
  "wsl.onboarding.installOpencode": "Instaliraj VPS Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "VPS Code nije instaliran",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) je potreban da bi VPS Code mogao dodati WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL nije dostupan",
  "wsl.onboarding.wslUnavailable.description": "VPS Code nije mogao provjeriti WSL na ovom uređaju.",
  "wsl.onboarding.installWsl": "Instaliraj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokreni Windows da završiš instalaciju WSL-a, zatim ponovo otvori VPS Code.",
  ...
  "help.tabs.introduction": "VPS Code Desktop sada je organizovan oko kartica.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova verzija VPS Code-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku VPS Code timu",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: VPS Code još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "VPS Code uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni VPS Code server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u VPS Code-u",
  ...
  "settings.general.row.appearance.description": "Prilagodi kako VPS Code izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li VPS Code prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu VPS Code-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se VPS Code pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju VPS Code-a.",
