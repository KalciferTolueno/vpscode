export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacioni VPS Code",
  ...
  "desktop.menu.ariaLabel": "Menuja VPS Code",
  ...
  "desktop.recovery.loadFailed": "VPS Code nuk u ngarkua",
  "desktop.recovery.terminated": "Dritarja VPS Code u mbyll papritur",
  "desktop.recovery.unresponsive": "VPS Code nuk po përgjigjet",
  ...
  "desktop.wsl.error.installOpencode": "Instalimi i VPS Code dështoi",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "VPS Code nuk është i instaluar në {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Përditësimi i VPS Code përfundoi, por {{distro}} ende raporton {{installed}}; pritet {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Modele falas të ofruara nga VPS Code",
  ...
  "provider.connect.apiKey.description":
    "Futni çelësin API të {{provider}} për të lidhur llogarinë dhe për të përdorur modelet {{provider}} në VPS Code.",
  ...
  "provider.connect.opencodeZen.line1":
    "VPS Code Zen ju jep akses në një grup të kuruar modelesh të optimizuara të besueshme për agjentët e kodimit.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " për të mbledhur kodin tuaj të autorizimit për të lidhur llogarinë tuaj dhe për të përdorur modelet {{provider}} në VPS Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dhe futni kodin më poshtë për të lidhur llogarinë tuaj dhe për të përdorur modelet {{provider}} në VPS Code.",
  ...
  "dialog.server.description": "Ndrysho me cilin server VPS Code lidhet ky aplikacion.",
  ...
  "wsl.onboarding.checkingOpencode": "Po kontrollon VPS Code...",
  "wsl.onboarding.checkingOpencodeIn": "Po kontrollon VPS Code në {{distro}}...",
  "wsl.onboarding.updatingOpencode": "VPS Code po përditësohet...",
  "wsl.onboarding.updatingOpencodeIn": "Po përditëson VPS Code në {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Përditëso VPS Code në {{distro}}.",
  "wsl.onboarding.updateOpencode": "Përditëso VPS Code",
  "wsl.onboarding.opencodeReadyIn": "VPS Code është gati në {{distro}}.",
  "wsl.onboarding.opencodeReady": "VPS Code është gati.",
  "wsl.onboarding.installOpencodeIn": "Instaloni VPS Code në {{distro}}.",
  "wsl.onboarding.installOpencode": "Instaloni VPS Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "VPS Code nuk është i instaluar",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Nënsistemi Windows për Linux) kërkohet përpara se VPS Code të shtojë një server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL i padisponueshëm",
  "wsl.onboarding.wslUnavailable.description": "VPS Code nuk mund ta verifikonte WSL në këtë makinë.",
  "wsl.onboarding.installWsl": "Instaloni WSL",
  "wsl.onboarding.windowsRestartRequired": "Rinis Windows për të përfunduar instalimin e WSL, më pas rihap VPS Code.",
  ...
  "help.tabs.introduction": "VPS Code Desktop tani është ndërtuar rreth skedave.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Një version i ri i VPS Code ({{version}}) është tani i disponueshëm për t'u instaluar.",
  ...
  "error.page.report.prefix": "Ju lutemi raportoni këtë gabim te ekipi i VPS Code",
  ...
  "error.chain.mcpFailed": 'Serveri MCP "{{name}}" dështoi. Shënim, VPS Code nuk e mbështet ende vërtetimin MCP.',
  ...
  "sidebar.gettingStarted.line1": "VPS Code përfshin modele falas, kështu që mund të filloni menjëherë.",
  ...
  "settings.desktop.wsl.description": "Ekzekutoni serverin VPS Code brenda WSL në Windows.",
  ...
  "settings.general.row.language.description": "Ndryshoni gjuhën e ekranit për VPS Code",
  ...
  "settings.general.row.appearance.description": "Personalizojeni se si duket VPS Code në pajisjen tuaj",
  "settings.general.row.colorScheme.title": "Skema e ngjyrave",
  "settings.general.row.colorScheme.description":
    "Zgjidhni nëse VPS Code ndjek temën e sistemit, të lehtë ose të errët",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalizojeni se si është tema e VPS Code.",
  ...
  "settings.updates.row.startup.description": "Kontrolloni automatikisht për përditësime kur niset VPS Code",
  ...
  "settings.updates.toast.latest.description": "Ju jeni duke ekzekutuar versionin më të fundit të VPS Code.",
