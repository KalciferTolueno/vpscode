export const dict = {
  ...
  "desktop.menu.documentation": "Documentação do VPS Code",
  ...
  "desktop.menu.ariaLabel": "Menu do VPS Code",
  ...
  "desktop.recovery.loadFailed": "Falha ao carregar o VPS Code",
  "desktop.recovery.terminated": "A janela do VPS Code foi encerrada inesperadamente",
  "desktop.recovery.unresponsive": "O VPS Code não está respondendo",
  ...
  "desktop.wsl.error.installOpencode": "Falha na instalação do VPS Code",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "O VPS Code não está instalado em {{distro}}",
  "desktop.wsl.error.updateVersion":
    "A atualização do VPS Code foi concluída, mas {{distro}} ainda informa a versão {{installed}}; a versão esperada é {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo VPS Code",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no VPS Code.",
  ...
  "provider.connect.opencodeZen.line1":
    "VPS Code Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no VPS Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no VPS Code.",
  ...
  "dialog.server.description": "Trocar para qual servidor VPS Code este aplicativo se conecta.",
  ...
  "wsl.onboarding.checkingOpencode": "Verificando o VPS Code...",
  "wsl.onboarding.checkingOpencodeIn": "Verificando o VPS Code em {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Atualizando o VPS Code...",
  "wsl.onboarding.updatingOpencodeIn": "Atualizando o VPS Code em {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Atualize o VPS Code em {{distro}}.",
  "wsl.onboarding.updateOpencode": "Atualizar o VPS Code",
  "wsl.onboarding.opencodeReadyIn": "O VPS Code está pronto em {{distro}}.",
  "wsl.onboarding.opencodeReady": "O VPS Code está pronto.",
  "wsl.onboarding.installOpencodeIn": "Instale o VPS Code em {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar o VPS Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "VPS Code não instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "O WSL (Windows Subsystem for Linux) é necessário para que o VPS Code possa adicionar um servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponível",
  "wsl.onboarding.wslUnavailable.description": "O VPS Code não conseguiu verificar o WSL neste computador.",
  "wsl.onboarding.installWsl": "Instalar o WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicie o Windows para concluir a instalação do WSL e abra o VPS Code novamente.",
  ...
  "help.tabs.introduction": "Agora, o VPS Code Desktop é organizado em abas.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Uma nova versão do VPS Code ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do VPS Code",
  ...
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: VPS Code ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "VPS Code inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor VPS Code dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do VPS Code",
  ...
  "settings.general.row.appearance.description": "Personalize como o VPS Code aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o VPS Code segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o VPS Code é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o VPS Code iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do VPS Code.",
