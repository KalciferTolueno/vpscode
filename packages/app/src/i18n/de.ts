...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von VPS Code",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren API-Schlüssel für {{provider}} ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in VPS Code zu nutzen.",
  ...
  "provider.connect.opencodeZen.line1":
    "VPS Code Zen bietet Ihnen Zugriff auf eine kuratierte Auswahl zuverlässiger, optimierter Modelle für Coding-Agenten.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}}-Modelle in VPS Code zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in VPS Code zu nutzen.",
  ...
  "dialog.server.description": "Wechseln Sie den VPS Code-Server, mit dem sich diese App verbindet.",
  ...
  "wsl.onboarding.checkingOpencode": "VPS Code wird geprüft…",
  "wsl.onboarding.checkingOpencodeIn": "VPS Code in {{distro}} wird geprüft…",
  "wsl.onboarding.updatingOpencode": "VPS Code wird aktualisiert…",
  "wsl.onboarding.updatingOpencodeIn": "VPS Code in {{distro}} wird aktualisiert…",
  "wsl.onboarding.updateOpencodeIn": "Aktualisieren Sie VPS Code in {{distro}}.",
  "wsl.onboarding.updateOpencode": "VPS Code aktualisieren",
  "wsl.onboarding.opencodeReadyIn": "VPS Code ist in {{distro}} bereit.",
  "wsl.onboarding.opencodeReady": "VPS Code ist bereit.",
  "wsl.onboarding.installOpencodeIn": "Installieren Sie VPS Code in {{distro}}.",
  "wsl.onboarding.installOpencode": "VPS Code installieren",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "VPS Code nicht installiert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) ist erforderlich, bevor VPS Code einen WSL-Server hinzufügen kann",
  "wsl.onboarding.wslUnavailable.title": "WSL nicht verfügbar",
  "wsl.onboarding.wslUnavailable.description": "VPS Code konnte WSL auf diesem Computer nicht überprüfen.",
  "wsl.onboarding.installWsl": "WSL installieren",
  "wsl.onboarding.windowsRestartRequired":
    "Starten Sie Windows neu, um die WSL-Installation abzuschließen, und öffnen Sie dann VPS Code erneut.",
  ...
  "toast.update.description": "Eine neue Version von VPS Code ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem VPS Code-Team",
  ...
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: VPS Code unterstützt noch keine MCP-Authentifizierung.',
  ...
  "home.providerTip":
    "VPS Code mit über 75 Anbietern verbinden, um weitere Modelle wie Claude, GPT, Gemini und andere zu nutzen",
  ...
  "sidebar.gettingStarted.line1": "VPS Code enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "settings.desktop.wsl.description": "VPS Code-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für VPS Code ändern",
  ...
  "settings.general.row.appearance.description": "Anpassen, wie VPS Code auf Ihrem Gerät aussieht",
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description":
    "Wählen Sie, ob VPS Code dem System-, hellen oder dunklen Thema folgt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von VPS Code anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von VPS Code automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.title": "VPS Code ist auf dem neuesten Stand",
  "settings.updates.toast.latest.description": "Die aktuelle Version von VPS Code wird verwendet.",
  ...
  "desktop.recovery.loadFailed": "VPS Code konnte nicht geladen werden",
  "desktop.recovery.terminated": "Das VPS Code-Fenster wurde unerwartet beendet",
  "desktop.recovery.unresponsive": "VPS Code reagiert nicht",
  ...
  "desktop.wsl.error.installOpencode": "VPS Code-Installation fehlgeschlagen",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "VPS Code ist in {{distro}} nicht installiert",
  "desktop.wsl.error.updateVersion":
    "Das VPS Code-Update wurde abgeschlossen, aber {{distro}} meldet weiterhin {{installed}}; erwartet wurde {{expected}}",
  ...
  "help.tabs.introduction": "VPS Code Desktop basiert jetzt auf Tabs.",
  "help.tabs.sessions":
