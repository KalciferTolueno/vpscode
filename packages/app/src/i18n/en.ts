...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by VPS Code",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in VPS Code.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.opencodeZen.line1":
    "VPS Code Zen gives you access to a curated set of reliable optimized models for coding agents.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in VPS Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in VPS Code.",
  ...
  "file.saveFailed": "Couldn't save the file",
  ...
  "dialog.server.description": "Switch which VPS Code server this app connects to.",
  ...
  "wsl.onboarding.checkingOpencode": "Checking VPS Code...",
  "wsl.onboarding.checkingOpencodeIn": "Checking VPS Code in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Updating VPS Code...",
  "wsl.onboarding.updatingOpencodeIn": "Updating VPS Code in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Update VPS Code in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Update VPS Code",
  "wsl.onboarding.opencodeReadyIn": "VPS Code is ready in {{distro}}.",
  "wsl.onboarding.opencodeReady": "VPS Code is ready.",
  "wsl.onboarding.installOpencodeIn": "Install VPS Code in {{distro}}.",
  "wsl.onboarding.installOpencode": "Install VPS Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "VPS Code not installed",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before VPS Code can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "VPS Code could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen VPS Code.",
  ...
  "help.tabs.introduction": "VPS Code Desktop is now built around tabs.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "A new version of VPS Code ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the VPS Code team",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, VPS Code does not support MCP authentication yet.',
  ...
  "session.preview.url": "Preview URL",
  "session.preview.reload": "Reload preview",
  "session.preview.back": "Back",
  "session.preview.forward": "Forward",
  "session.preview.openExternal": "Open in new tab",
  "session.preview.placeholder": "localhost:5173 or /preview/<port>/",
  "session.preview.empty": "The app will appear here as soon as it is running.",
  "session.preview.openBrowser": "Open browser",
  "session.preview.console": "Console",
  "session.preview.consoleEmpty": "No messages yet. Logs, warnings, errors, and failed requests appear here.",
  "session.preview.responsive": "Responsive",
  "session.preview.responsive.desktop": "Desktop",
  "session.preview.responsive.tablet": "Tablet",
  "session.preview.responsive.mobile": "Mobile",
  "session.preview.pickElement": "Select element",
  "session.preview.element": "element",
  "session.preview.zoomIn": "Zoom in",
  "session.preview.zoomOut": "Zoom out",
  "session.preview.zoom": "Zoom",
  "session.studio.views": "Preview and code",
  "session.studio.empty": "The app will appear here as soon as it is running.",
  "session.studio.download": "Download",
  "session.studio.downloadZip": "Download project ZIP",
  "session.studio.downloadFailed": "Could not download",
  "session.studio.fullscreen": "Full screen",
  "session.studio.exitFullscreen": "Exit full screen",
  ...
  "sidebar.gettingStarted.line1": "VPS Code includes free models so you can start immediately.",
  ...
  "settings.desktop.wsl.description": "Run the VPS Code server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for VPS Code",
  "settings.general.row.shell.title": "Terminal shell",
  "settings.general.row.shell.description": "Shell used by the terminal and agent tools",
  "settings.general.row.shell.autoDefault": "Auto (Default)",
  "settings.general.row.shell.terminalOnly": "terminal only",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how VPS Code looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether VPS Code follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how VPS Code is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when VPS Code launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of VPS Code.",
  ...
  "settings.skills.description": "Global skills available to every project",
  "settings.skills.loading": "Loading skills...",
  "settings.skills.empty": "No global skills installed",
  "settings.skills.toast.updateFailed": "Failed to update skills",
