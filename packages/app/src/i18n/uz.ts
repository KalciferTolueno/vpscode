export const dict = {
  ...
  "desktop.menu.documentation": "VPS Code hujjatlari",
  ...
  "desktop.menu.ariaLabel": "VPS Code menyusi",
  ...
  "desktop.recovery.loadFailed": "VPS Code yuklanmadi",
  "desktop.recovery.terminated": "VPS Code oynasi kutilmaganda tugatildi",
  "desktop.recovery.unresponsive": "VPS Code javob bermayapti",
  ...
  "desktop.wsl.error.installOpencode": "VPS Code oʻrnatilmadi",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "VPS Code {{distro}} da o'rnatilmagan",
  "desktop.wsl.error.updateVersion":
    "VPS Code yangilanishi tugallandi, lekin {{distro}} hali ham {{installed}} haqida xabar beradi; kutilgan {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "VPS Code tomonidan taqdim etilgan bepul modellar",
  ...
  "provider.connect.apiKey.description":
    "Hisobingizni ulash va VPS Code’da {{provider}} modellaridan foydalanish uchun {{provider}} API kalitini kiriting.",
  ...
  "provider.connect.opencodeZen.line1":
    "VPS Code Zen sizga kodlash agentlari uchun ishonchli optimallashtirilgan modellar to'plamiga kirish imkonini beradi.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " hisobingizni ulash va VPS Code da {{provider}} modellaridan foydalanish uchun avtorizatsiya kodingizni yig'ish.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " va hisobingizni ulash uchun quyidagi kodni kiriting va VPS Code da {{provider}} modellaridan foydalaning.",
  ...
  "dialog.server.description": "Ushbu ilova qaysi VPS Code serveriga ulanishini almashtiring.",
  ...
  "wsl.onboarding.checkingOpencode": "VPS Code tekshirilmoqda...",
  "wsl.onboarding.checkingOpencodeIn": "VPS Code {{distro}} da tekshirilmoqda...",
  "wsl.onboarding.updatingOpencode": "VPS Code yangilanmoqda...",
  "wsl.onboarding.updatingOpencodeIn": "VPS Code {{distro}} da yangilanmoqda...",
  "wsl.onboarding.updateOpencodeIn": "VPS Code-ni {{distro}}-da yangilang.",
  "wsl.onboarding.updateOpencode": "VPS Code-ni yangilang",
  "wsl.onboarding.opencodeReadyIn": "VPS Code {{distro}} da tayyor.",
  "wsl.onboarding.opencodeReady": "VPS Code tayyor.",
  "wsl.onboarding.installOpencodeIn": "VPS Code-ni {{distro}}-ga o'rnating.",
  "wsl.onboarding.installOpencode": "VPS Code-ni o'rnating",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "VPS Code o'rnatilmagan",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "VPS Code WSL serverini qoʻshishdan oldin WSL (Linux uchun Windows quyi tizimi) talab qilinadi.",
  "wsl.onboarding.wslUnavailable.title": "WSL mavjud emas",
  "wsl.onboarding.wslUnavailable.description": "VPS Code WSL ni ushbu mashinada tasdiqlay olmadi.",
  "wsl.onboarding.installWsl": "WSL-ni o'rnating",
  "wsl.onboarding.windowsRestartRequired":
    "WSL-ni o'rnatishni tugatish uchun Windows-ni qayta ishga tushiring, so'ngra VPS Code-ni qayta oching.",
  ...
  "help.tabs.introduction": "VPS Code Desktop endi yorliqlar atrofida qurilgan.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "VPS Code ({{version}}) yangi versiyasi endi oʻrnatish mumkin.",
  ...
  "error.page.report.prefix": "Iltimos, ushbu xato haqida VPS Code jamoasiga xabar bering",
  ...
  "error.chain.mcpFailed":
    "MCP \"{{name}}\" serveri muvaffaqiyatsiz tugadi. E'tibor bering, VPS Code hali MCP autentifikatsiyasini qo'llab-quvvatlamaydi.",
  ...
  "sidebar.gettingStarted.line1":
    "VPS Code bepul modellarni o'z ichiga oladi, shuning uchun siz darhol boshlashingiz mumkin.",
  ...
  "settings.desktop.wsl.description": "Windows da WSL ichidagi VPS Code serverini ishga tushiring.",
  ...
  "settings.general.row.language.description": "VPS Code uchun ekran tilini o'zgartiring",
  ...
  "settings.general.row.appearance.description": "VPS Code qurilmangizda qanday koʻrinishini sozlang",
  "settings.general.row.colorScheme.title": "Rang sxemasi",
  "settings.general.row.colorScheme.description":
    "VPS Code tizimga, yorugʻlik yoki qorongʻi mavzuga amal qilishini tanlang",
  "settings.general.row.theme.title": "Mavzu",
  "settings.general.row.theme.description": "VPS Code mavzusini sozlash.",
  ...
  "settings.updates.row.startup.description": "VPS Code ishga tushganda avtomatik ravishda yangilanishlarni tekshiring",
  ...
  "settings.updates.toast.latest.description": "Siz VPS Code oxirgi versiyasini ishga tushiryapsiz.",
