export const dict = {
  ...
  "desktop.recovery.loadFailed": "VPS Code yüklənə bilmədi",
  "desktop.recovery.terminated": "VPS Code pəncərəsinin işi gözlənilmədən dayandı",
  "desktop.recovery.unresponsive": "VPS Code cavab vermir",
  ...
  "desktop.wsl.error.installOpencode": "VPS Code quraşdırılması uğursuz oldu",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "VPS Code {{distro}} distribütivində quraşdırılmayıb",
  "desktop.wsl.error.updateVersion":
    "VPS Code yeniləməsi tamamlandı, lakin {{distro}} hələ də {{installed}} versiyasını bildirir; gözlənilən versiya: {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "VPS Code tərəfindən təqdim olunan pulsuz modellər",
  ...
  "provider.connect.apiKey.description":
    "Hesabınızı qoşmaq və VPS Code-da {{provider}} modellərindən istifadə etmək üçün {{provider}} API açarınızı daxil edin.",
  ...
  "provider.connect.opencodeZen.line1":
    "VPS Code Zen sizə kodlaşdırma agentləri üçün etibarlı optimallaşdırılmış seçilmiş modellər dəstinə giriş verir.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " daxil olub hesabınızı qoşmaq və VPS Code-da {{provider}} modellərindən istifadə etmək üçün avtorizasiya kodunuzu əldə edin.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " daxil olub aşağıdakı kodu daxil edərək hesabınızı qoşun və VPS Code-da {{provider}} modellərindən istifadə edin.",
  ...
  "dialog.server.description": "Bu tətbiqin qoşulduğu VPS Code serverini dəyişdirin.",
  ...
  "wsl.onboarding.checkingOpencode": "VPS Code yoxlanılır...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}}-də VPS Code yoxlanılır...",
  "wsl.onboarding.updatingOpencode": "VPS Code yenilənir...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}-də VPS Code yenilənir...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}}-də VPS Code-u yeniləyin.",
  "wsl.onboarding.updateOpencode": "VPS Code-u yeniləyin",
  "wsl.onboarding.opencodeReadyIn": "VPS Code {{distro}}-də hazırdır.",
  "wsl.onboarding.opencodeReady": "VPS Code hazırdır.",
  "wsl.onboarding.installOpencodeIn": "VPS Code-u {{distro}}-də quraşdırın.",
  "wsl.onboarding.installOpencode": "VPS Code quraşdırın",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "VPS Code quraşdırılmayıb",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "VPS Code WSL serveri əlavə etməzdən əvvəl WSL (Linux üçün Windows alt sistemi) tələb olunur",
  "wsl.onboarding.wslUnavailable.title": "WSL mövcud deyil",
  "wsl.onboarding.wslUnavailable.description": "VPS Code bu maşında WSL-i doğrulaya bilmədi.",
  "wsl.onboarding.installWsl": "WSL quraşdırın",
  "wsl.onboarding.windowsRestartRequired":
    "WSL-nin quraşdırılmasını başa çatdırmaq üçün Windows-u yenidən başladın, sonra VPS Code-u yenidən açın.",
  ...
  "help.tabs.introduction": "VPS Code Desktop indi tablar əsasında qurulub.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "VPS Code-un yeni versiyası ({{version}}) quraşdırma üçün mövcuddur.",
  ...
  "error.page.report.prefix": "Bu xətanı VPS Code komandasına bildirin",
  ...
  "error.chain.mcpFailed":
    'MCP server "{{name}}" uğursuz oldu. Qeyd: VPS Code hələ MCP autentifikasiyasını dəstəkləmir.',
  ...
  "sidebar.gettingStarted.line1": "VPS Code-a pulsuz modellər daxildir, buna görə dərhal başlaya bilərsiniz.",
  ...
  "settings.desktop.wsl.description": "Windows-da WSL daxilində VPS Code serverini işlət.",
  ...
  "settings.general.row.language.description": "VPS Code üçün ekran dilini dəyişdirin",
  ...
  "settings.general.row.appearance.description": "VPS Code-un cihazınızda necə göründüyünü fərdiləşdirin",
  "settings.general.row.colorScheme.title": "Rəng sxemi",
  "settings.general.row.colorScheme.description":
    "VPS Code-un sistem, açıq və ya tünd mövzudan istifadə etməsini seçin",
  "settings.general.row.theme.title": "Mövzu",
  "settings.general.row.theme.description": "VPS Code-un mövzusunu fərdiləşdirin.",
  ...
  "settings.updates.row.startup.description": "VPS Code açıldıqda avtomatik yeniləmələri yoxla",
  ...
  "settings.updates.toast.latest.description": "VPS Code-un ən son versiyasından istifadə edirsiniz.",
