export const dict = {
  ...
  "desktop.recovery.loadFailed": "VPS Code laadimine ebaõnnestus",
  "desktop.recovery.terminated": "VPS Code aken suleti ootamatult",
  "desktop.recovery.unresponsive": "VPS Code ei vasta",
  ...
  "desktop.wsl.error.installOpencode": "VPS Code installimine ebaõnnestus",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "VPS Code pole installitud asukohta {{distro}}",
  "desktop.wsl.error.updateVersion":
    "VPS Code värskendus on lõpetatud, kuid {{distro}} teatab endiselt {{installed}}; oodata {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Tasuta mudeleid pakub VPS Code",
  ...
  "provider.connect.apiKey.description":
    "Sisestage {{provider}} API võti, et ühendada konto ja kasutada {{provider}} mudeleid VPS Code'is.",
  ...
  "provider.connect.opencodeZen.line1":
    "VPS Code Zen annab teile juurdepääsu kodeerimisagentide usaldusväärsete optimeeritud mudelite kureeritud komplektile.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " konto ühendamiseks autoriseerimiskoodi kogumiseks ja {{provider}} mudeli kasutamiseks jaotises VPS Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " ja sisestage allolev kood, et ühendada oma konto ja kasutada {{provider}} mudelit jaotises VPS Code.",
  ...
  "dialog.server.description": "Lülitage, millise VPS Code serveriga see rakendus ühenduse loob.",
  ...
  "wsl.onboarding.checkingOpencode": "VPS Code kontrollimine...",
  "wsl.onboarding.checkingOpencodeIn": "VPS Code kontrollimine asukohas {{distro}}...",
  "wsl.onboarding.updatingOpencode": "VPS Code värskendamine...",
  "wsl.onboarding.updatingOpencodeIn": "VPS Code värskendamine asukohas {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Värskenda VPS Code jaotises {{distro}}.",
  "wsl.onboarding.updateOpencode": "Värskenda VPS Code",
  "wsl.onboarding.opencodeReadyIn": "VPS Code on valmis {{distro}}.",
  "wsl.onboarding.opencodeReady": "VPS Code on valmis.",
  "wsl.onboarding.installOpencodeIn": "Installige VPS Code asukohta {{distro}}.",
  "wsl.onboarding.installOpencode": "Installige VPS Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "VPS Code pole installitud",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows alamsüsteem Linux jaoks) on nõutav, enne kui VPS Code saab lisada WSL serveri",
  "wsl.onboarding.wslUnavailable.title": "WSL pole saadaval",
  "wsl.onboarding.wslUnavailable.description": "VPS Code ei saanud selles masinas kontrollida WSL.",
  "wsl.onboarding.installWsl": "Installige WSL",
  "wsl.onboarding.windowsRestartRequired": "Taaskäivitage Windows, et installida WSL, seejärel avage uuesti VPS Code.",
  ...
  "help.tabs.introduction": "VPS Code Töölaud on nüüd üles ehitatud vahekaartide ümber.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Rakenduse VPS Code ({{version}}) uus versioon on nüüd installimiseks saadaval.",
  ...
  "error.page.report.prefix": "Teatage sellest veast VPS Code meeskonnale",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" ebaõnnestus. Pange tähele, VPS Code ei toeta veel MCP autentimist.',
  ...
  "sidebar.gettingStarted.line1": "VPS Code sisaldab tasuta mudeleid, nii et saate kohe alustada.",
  ...
  "app.name.desktop": "VPS Code Töölaud",
  ...
  "settings.desktop.wsl.description": "Käivitage VPS Code server sees WSL saidil Windows.",
  ...
  "settings.general.row.language.description": "Muutke VPS Code kuvakeelt",
  ...
  "settings.general.row.appearance.description": "Kohandage, kuidas VPS Code teie seadmes välja näeb",
  "settings.general.row.colorScheme.title": "Värvilahendus",
  "settings.general.row.colorScheme.description": "Valige, kas VPS Code järgib süsteemi, heledat või tumedat teemat",
  "settings.general.row.theme.title": "Teema",
  "settings.general.row.theme.description": "Kohandage, kuidas VPS Code on teemastatud.",
  ...
  "settings.updates.row.startup.description": "Kontrollige automaatselt värskendusi, kui VPS Code käivitub",
  ...
  "settings.updates.toast.latest.description": "Kasutate rakenduse VPS Code uusimat versiooni.",
