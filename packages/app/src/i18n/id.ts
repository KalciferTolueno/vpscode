export const dict = {
  ...
  "desktop.recovery.loadFailed": "VPS Code gagal dimuat",
  "desktop.recovery.terminated": "Jendela VPS Code berhenti secara tidak terduga",
  "desktop.recovery.unresponsive": "VPS Code tidak merespons",
  ...
  "desktop.wsl.error.installOpencode": "Instalasi VPS Code gagal",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "VPS Code belum terinstal di {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Pembaruan VPS Code selesai, tetapi {{distro}} masih melaporkan {{installed}}; seharusnya {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Model gratis disediakan oleh VPS Code",
  ...
  "provider.connect.apiKey.description":
    "Masukkan kunci API {{provider}} untuk menghubungkan akun Anda dan gunakan model {{provider}} di VPS Code.",
  ...
  "provider.connect.opencodeZen.line1":
    "VPS Code Zen memberi Anda akses ke serangkaian model andal yang dioptimalkan untuk agen pengodean.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " untuk mendapatkan kode otorisasi guna menghubungkan akun Anda dan menggunakan model {{provider}} di VPS Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dan masukkan kode di bawah untuk menghubungkan akun dan menggunakan model {{provider}} di VPS Code.",
  ...
  "dialog.server.description": "Ganti server VPS Code mana yang terhubung dengan aplikasi ini.",
  ...
  "wsl.onboarding.checkingOpencode": "Memeriksa VPS Code...",
  "wsl.onboarding.checkingOpencodeIn": "Memeriksa VPS Code di {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Memperbarui VPS Code...",
  "wsl.onboarding.updatingOpencodeIn": "Memperbarui VPS Code di {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Perbarui VPS Code di {{distro}}.",
  "wsl.onboarding.updateOpencode": "Perbarui VPS Code",
  "wsl.onboarding.opencodeReadyIn": "VPS Code siap di {{distro}}.",
  "wsl.onboarding.opencodeReady": "VPS Code siap.",
  "wsl.onboarding.installOpencodeIn": "Instal VPS Code di {{distro}}.",
  "wsl.onboarding.installOpencode": "Instal VPS Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "VPS Code belum terinstal",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) diperlukan sebelum VPS Code dapat menambahkan server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL tidak tersedia",
  "wsl.onboarding.wslUnavailable.description": "VPS Code tidak dapat memverifikasi WSL di komputer ini.",
  "wsl.onboarding.installWsl": "Instal WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Mulai ulang Windows untuk menyelesaikan instalasi WSL, lalu buka kembali VPS Code.",
  ...
  "help.tabs.introduction": "VPS Code Desktop kini dirancang dengan tab sebagai pusatnya.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Versi baru VPS Code ({{version}}) sekarang tersedia untuk diinstal.",
  ...
  "error.page.report.prefix": "Harap laporkan kesalahan ini ke tim VPS Code",
  ...
  "error.chain.mcpFailed": 'Server MCP "{{name}}" gagal. Catatan: VPS Code belum mendukung autentikasi MCP.',
  ...
  "sidebar.gettingStarted.line1": "VPS Code menyertakan model gratis sehingga Anda dapat memulai dengan segera.",
  ...
  "settings.desktop.wsl.description": "Jalankan server VPS Code di dalam WSL di Windows.",
  ...
  "settings.general.row.language.description": "Ubah bahasa tampilan untuk VPS Code",
  ...
  "settings.general.row.appearance.description": "Sesuaikan tampilan VPS Code di perangkat Anda",
  "settings.general.row.colorScheme.title": "Skema warna",
  "settings.general.row.colorScheme.description": "Pilih apakah VPS Code mengikuti tema sistem, terang, atau gelap",
  ...
  "settings.updates.row.startup.description": "Secara otomatis memeriksa pembaruan saat VPS Code diluncurkan",
  ...
  "settings.updates.toast.latest.description": "Anda menjalankan versi terbaru VPS Code.",
