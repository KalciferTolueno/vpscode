export const dict = {
  ...
  "desktop.menu.documentation": "VPS Code دستاویزات",
  ...
  "desktop.menu.ariaLabel": "VPS Code مینو",
  ...
  "desktop.recovery.loadFailed": "VPS Code لوڈ نہیں ہو سکا",
  "desktop.recovery.terminated": "VPS Code ونڈو غیر متوقع طور پر بند ہو گئی",
  "desktop.recovery.unresponsive": "VPS Code جواب نہیں دے رہا",
  ...
  "desktop.wsl.error.installOpencode": "VPS Code کی تنصیب ناکام ہو گئی",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}} میں VPS Code انسٹال نہیں ہے",
  "desktop.wsl.error.updateVersion":
    "VPS Code کی اپ ڈیٹ مکمل ہو گئی لیکن {{distro}} اب بھی {{installed}} کی اطلاع دے رہا ہے؛ متوقع ورژن {{expected}} ہے",
  ...
  "dialog.model.unpaid.freeModels.title": "VPS Code کے ذریعہ فراہم کردہ مفت ماڈلز",
  ...
  "provider.connect.apiKey.description":
    "اپنا اکاؤنٹ منسلک کرنے اور VPS Code میں {{provider}} ماڈلز استعمال کرنے کے لیے اپنی {{provider}} API کلید درج کریں۔",
  ...
  "provider.connect.opencodeZen.line1":
    "VPS Code Zen آپ کو کوڈنگ ایجنٹوں کے لیے قابل اعتماد اصلاح شدہ ماڈلز کے کیوریٹڈ سیٹ تک رسائی فراہم کرتا ہے۔",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "، اپنا اجازت نامہ حاصل کریں، اکاؤنٹ منسلک کریں اور VPS Code میں {{provider}} ماڈلز استعمال کریں۔",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " اور نیچے دیا گیا کوڈ درج کرکے اپنا اکاؤنٹ منسلک کریں اور VPS Code میں {{provider}} ماڈلز استعمال کریں۔",
  ...
  "dialog.server.description": "سوئچ کریں کہ یہ ایپ کس VPS Code سرور سے منسلک ہے۔",
  ...
  "wsl.onboarding.checkingOpencode": "VPS Code چیک کیا جا رہا ہے...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} میں VPS Code چیک کیا جا رہا ہے...",
  "wsl.onboarding.updatingOpencode": "VPS Code کو اپ ڈیٹ کیا جا رہا ہے...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} میں VPS Code کو اپ ڈیٹ کیا جا رہا ہے...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}} میں VPS Code کو اپ ڈیٹ کریں۔",
  "wsl.onboarding.updateOpencode": "VPS Code کو اپ ڈیٹ کریں۔",
  "wsl.onboarding.opencodeReadyIn": "VPS Code {{distro}} میں تیار ہے۔",
  "wsl.onboarding.opencodeReady": "VPS Code تیار ہے۔",
  "wsl.onboarding.installOpencodeIn": "{{distro}} میں VPS Code انسٹال کریں۔",
  "wsl.onboarding.installOpencode": "VPS Code انسٹال کریں۔",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "VPS Code انسٹال نہیں ہے۔",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows سب سسٹم برائے Linux) کی ضرورت ہے اس سے پہلے کہ VPS Code WSL سرور شامل کر سکے۔",
  "wsl.onboarding.wslUnavailable.title": "WSL دستیاب نہیں ہے۔",
  "wsl.onboarding.wslUnavailable.description": "VPS Code اس مشین پر WSL کی تصدیق نہیں کر سکا۔",
  "wsl.onboarding.installWsl": "WSL انسٹال کریں۔",
  "wsl.onboarding.windowsRestartRequired":
    "WSL انسٹال کرنے کے لیے Windows کو دوبارہ شروع کریں، پھر VPS Code کو دوبارہ کھولیں۔",
  ...
  "help.tabs.introduction": "VPS Code Desktop اب ٹیبز پر مبنی ہے۔",
  "help.tabs.sessions":
  ...
  "toast.update.description": "VPS Code ({{version}}) کا ایک نیا ورژن اب انسٹال کرنے کے لیے دستیاب ہے۔",
  ...
  "error.page.report.prefix": "براہ کرم VPS Code ٹیم کو اس غلطی کی اطلاع دیں۔",
  ...
  "error.chain.mcpFailed": 'MCP سرور "{{name}}" ناکام ہو گیا۔ نوٹ، VPS Code ابھی تک MCP تصدیق کو سپورٹ نہیں کرتا ہے۔',
  ...
  "sidebar.gettingStarted.line1": "VPS Code میں مفت ماڈل شامل ہیں لہذا آپ فوری طور پر شروع کر سکتے ہیں۔",
  ...
  "app.name.desktop": "VPS Code ڈیسک ٹاپ",
  ...
  "settings.desktop.wsl.description": "Windows پر WSL کے اندر VPS Code سرور چلائیں۔",
  ...
  "settings.general.row.language.description": "VPS Code کے لیے ڈسپلے کی زبان تبدیل کریں۔",
  ...
  "settings.general.row.appearance.description": "اپنی مرضی کے مطابق بنائیں کہ آپ کے آلے پر VPS Code کیسا لگتا ہے۔",
  "settings.general.row.colorScheme.title": "رنگ سکیم",
  "settings.general.row.colorScheme.description":
    "منتخب کریں کہ آیا VPS Code سسٹم، لائٹ یا ڈارک تھیم کی پیروی کرتا ہے۔",
  "settings.general.row.theme.title": "تھیم",
  "settings.general.row.theme.description": "VPS Code کی تھیم حسب ضرورت بنائیں۔",
  ...
  "settings.updates.row.startup.description": "VPS Code لانچ ہونے پر اپ ڈیٹس کے لیے خودکار طور پر چیک کریں۔",
  ...
  "settings.updates.toast.latest.description": "آپ VPS Code کا تازہ ترین ورژن چلا رہے ہیں۔",
