export const dict = {
  ...
  "desktop.menu.documentation": "VPS Code Документация",
  ...
  "desktop.recovery.loadFailed": "VPS Code не успя да се зареди",
  "desktop.recovery.terminated": "Прозорецът VPS Code приключи неочаквано",
  "desktop.recovery.unresponsive": "VPS Code не отговаря",
  ...
  "desktop.wsl.error.installOpencode": "Инсталирането на VPS Code е неуспешно",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "VPS Code не е инсталиран в {{distro}}",
  "desktop.wsl.error.updateVersion":
    "VPS Code актуализацията приключи, но {{distro}} все още съобщава {{installed}}; очаквано {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Безплатни модели, предоставени от VPS Code",
  ...
  "provider.connect.apiKey.description":
    "Въведете своя {{provider}} API ключ, за да свържете акаунта си и да използвате {{provider}} модели в VPS Code.",
  ...
  "provider.connect.opencodeZen.line1":
    "VPS Code Zen ви дава достъп до подбран набор от надеждни оптимизирани модели за кодиращи агенти.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "за да вземете вашия код за оторизация, за да свържете акаунта си и да използвате {{provider}} модели в VPS Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "и въведете кода по-долу, за да свържете акаунта си и да използвате {{provider}} модели в VPS Code.",
  ...
  "dialog.server.description": "Превключете към кой VPS Code сървър се свързва това приложение.",
  ...
  "wsl.onboarding.checkingOpencode": "Проверява се VPS Code...",
  "wsl.onboarding.checkingOpencodeIn": "Проверява се VPS Code в {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Актуализиране на VPS Code...",
  "wsl.onboarding.updatingOpencodeIn": "Актуализиране на VPS Code в {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Актуализирайте VPS Code в {{distro}}.",
  "wsl.onboarding.updateOpencode": "Актуализация VPS Code",
  "wsl.onboarding.opencodeReadyIn": "VPS Code е готов в {{distro}}.",
  "wsl.onboarding.opencodeReady": "VPS Code е готов.",
  "wsl.onboarding.installOpencodeIn": "Инсталирайте VPS Code в {{distro}}.",
  "wsl.onboarding.installOpencode": "Инсталирайте VPS Code",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) се изисква, преди VPS Code да може да добави WSL сървър",
  "wsl.onboarding.wslUnavailable.title": "WSL не е наличен",
  "wsl.onboarding.wslUnavailable.description": "VPS Code не можа да провери WSL на тази машина.",
  "wsl.onboarding.installWsl": "Инсталирайте WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Рестартирайте Windows, за да завършите инсталирането на WSL, след което отворете отново VPS Code.",
  ...
  "help.tabs.introduction": "VPS Code Desktop вече е изграден около раздели.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Вече е достъпна за инсталиране нова версия на VPS Code ({{version}}).",
  ...
  "error.page.report.prefix": "Моля, докладвайте тази грешка на екипа на VPS Code",
  ...
  "error.chain.mcpFailed":
    'MCP сървър "{{name}}" не успя. Имайте предвид, че VPS Code все още не поддържа MCP удостоверяване.',
  ...
  "sidebar.gettingStarted.line1": "VPS Code включва безплатни модели, така че можете да започнете веднага.",
  ...
  "settings.desktop.wsl.description": "Стартирайте сървъра VPS Code вътре в WSL на Windows.",
  ...
  "settings.general.row.language.description": "Променете езика на дисплея за VPS Code",
  ...
  "settings.general.row.appearance.description": "Персонализирайте как изглежда VPS Code на вашето устройство",
  "settings.general.row.colorScheme.title": "Цветова схема",
  "settings.general.row.colorScheme.description": "Изберете дали VPS Code следва системната, светла или тъмна тема",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Персонализирайте как е тематично VPS Code.",
  ...
  "settings.updates.row.startup.description": "Автоматично проверявайте за актуализации при стартиране на VPS Code",
  ...
  "settings.updates.toast.latest.description": "Вие използвате най-новата версия на VPS Code.",
