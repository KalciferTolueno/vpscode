export const dict = {
  ...
  "desktop.menu.documentation": "VPS Code დოკუმენტაცია",
  ...
  "desktop.menu.ariaLabel": "VPS Code მენიუ",
  ...
  "desktop.recovery.loadFailed": "VPS Code ვერ ჩაიტვირთა",
  "desktop.recovery.terminated": "VPS Code ფანჯარა მოულოდნელად შეწყდა",
  "desktop.recovery.unresponsive": "VPS Code არ პასუხობს",
  ...
  "desktop.wsl.error.installOpencode": "VPS Code ინსტალაცია ვერ მოხერხდა",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "VPS Code არ არის დაინსტალირებული {{distro}}",
  "desktop.wsl.error.updateVersion":
    "VPS Code განახლება დასრულდა, მაგრამ {{distro}} კვლავ იუწყება {{installed}}; მოსალოდნელია {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "უფასო მოდელები მოწოდებულია VPS Code",
  ...
  "provider.connect.apiKey.description":
    "შეიყვანეთ თქვენი {{provider}} API გასაღები თქვენი ანგარიშის დასაკავშირებლად და გამოიყენეთ {{provider}} მოდელები VPS Code-ში.",
  ...
  "provider.connect.opencodeZen.line1":
    "VPS Code Zen გაძლევთ წვდომას კოდირების აგენტებისთვის საიმედო ოპტიმიზირებული მოდელების კურირებულ კომპლექტზე.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " შეაგროვეთ თქვენი ავტორიზაციის კოდი თქვენი ანგარიშის დასაკავშირებლად და გამოიყენოთ {{provider}} მოდელები VPS Code-ში.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " და შეიყვანეთ ქვემოთ კოდი თქვენი ანგარიშის დასაკავშირებლად და გამოიყენეთ {{provider}} მოდელები VPS Code-ში.",
  ...
  "dialog.server.description": "გადართეთ რომელ VPS Code სერვერს უკავშირდება ეს აპი.",
  ...
  "wsl.onboarding.checkingOpencode": "შემოწმებულია VPS Code...",
  "wsl.onboarding.checkingOpencodeIn": "შემოწმებულია VPS Code-ში {{distro}}...",
  "wsl.onboarding.updatingOpencode": "განახლება VPS Code...",
  "wsl.onboarding.updatingOpencodeIn": "VPS Code განახლება ხდება {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "განახლება VPS Code {{distro}}-ში.",
  "wsl.onboarding.updateOpencode": "განახლება VPS Code",
  "wsl.onboarding.opencodeReadyIn": "VPS Code მზად არის {{distro}}-ში.",
  "wsl.onboarding.opencodeReady": "VPS Code მზად არის.",
  "wsl.onboarding.installOpencodeIn": "დააინსტალირეთ VPS Code {{distro}}-ში.",
  "wsl.onboarding.installOpencode": "დააინსტალირეთ VPS Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "VPS Code არ არის დაინსტალირებული",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows ქვესისტემა Linux-ისთვის) საჭიროა, სანამ VPS Code შეძლებს WSL სერვერის დამატებას",
  "wsl.onboarding.wslUnavailable.title": "WSL მიუწვდომელია",
  "wsl.onboarding.wslUnavailable.description": "VPS Code ვერ დაადასტურა WSL ამ მოწყობილობაზე.",
  "wsl.onboarding.installWsl": "დააინსტალირეთ WSL",
  "wsl.onboarding.windowsRestartRequired":
    "გადატვირთეთ Windows WSL-ის ინსტალაციის დასასრულებლად, შემდეგ ხელახლა გახსენით VPS Code.",
  ...
  "help.tabs.introduction": "VPS Code სამუშაო მაგიდა ახლა აგებულია ჩანართების გარშემო.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "VPS Code-ის ({{version}}) ახალი ვერსია ახლა ხელმისაწვდომია დასაინსტალირებლად.",
  ...
  "error.page.report.prefix": "გთხოვთ, შეატყობინოთ ეს შეცდომა VPS Code გუნდს",
  ...
  "error.chain.mcpFailed":
    'MCP სერვერი "{{name}}" ვერ მოხერხდა. შენიშვნა, VPS Code ჯერ არ უჭერს მხარს MCP ავთენტიფიკაციას.',
  ...
  "sidebar.gettingStarted.line1": "VPS Code მოიცავს უფასო მოდელებს, ასე რომ თქვენ შეგიძლიათ დაუყოვნებლივ დაიწყოთ.",
  ...
  "app.name.desktop": "VPS Code სამუშაო მაგიდა",
  ...
  "settings.desktop.wsl.description": "გაუშვით VPS Code სერვერი WSL-ში Windows-ზე.",
  ...
  "settings.general.row.language.description": "შეცვალეთ ჩვენების ენა VPS Code",
  ...
  "settings.general.row.appearance.description": "მორგეთ, როგორ გამოიყურება VPS Code თქვენს მოწყობილობაზე",
  "settings.general.row.colorScheme.title": "ფერთა სქემა",
  "settings.general.row.colorScheme.description": "აირჩიეთ, მიჰყვება თუ არა VPS Code სისტემას, ღია თუ ბნელ თემას",
  "settings.general.row.theme.title": "თემა",
  "settings.general.row.theme.description": "მორგება, თუ როგორ არის VPS Code თემატური.",
  ...
  "settings.updates.row.startup.description": "ავტომატურად შეამოწმეთ განახლებები, როდესაც VPS Code გაშვება",
  ...
  "settings.updates.toast.latest.description": "თქვენ იყენებთ VPS Code-ის უახლეს ვერსიას.",
