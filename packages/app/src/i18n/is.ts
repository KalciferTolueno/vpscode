...
const desktop = [
  ...
  "Bíða áfram",
  "Hætta",
  "Ekki tókst að hlaða VPS Code",
  "VPS Code-glugganum var óvænt lokað",
  "VPS Code svarar ekki",
  ...
  "VPS Code er ekki uppsett í {{distro}}",
  "Uppfærslu VPS Code lauk en {{distro}} tilkynnir enn {{installed}}; vænt var {{expected}}",
  "engin útgáfa",
...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Ókeypis gerðir frá VPS Code",
  ...
  "provider.connect.apiKey.description":
    "Sláðu inn API-lykilinn þinn fyrir {{provider}} til að tengja reikninginn og nota líkön frá {{provider}} í VPS Code.",
  ...
  "provider.connect.opencodeZen.line1":
    "VPS Code Zen veitir þér aðgang að safni af áreiðanlegum og fínstilltum gerðum fyrir kóðunarmiðla.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "til að safna heimildarkóðanum þínum til að tengja reikninginn þinn og nota {{provider}} gerðir í VPS Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "og sláðu inn kóðann hér að neðan til að tengja reikninginn þinn og nota {{provider}} gerðir í VPS Code.",
  ...
  "dialog.server.description": "Skiptu um hvaða VPS Code miðlara þetta app tengist.",
  ...
  "wsl.onboarding.checkingOpencode": "Athugar VPS Code...",
  "wsl.onboarding.checkingOpencodeIn": "Athugar VPS Code í {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Uppfærir VPS Code...",
  "wsl.onboarding.updatingOpencodeIn": "Uppfærir VPS Code í {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Uppfærðu VPS Code í {{distro}}.",
  "wsl.onboarding.updateOpencode": "Uppfærðu VPS Code",
  "wsl.onboarding.opencodeReadyIn": "VPS Code er tilbúið í {{distro}}.",
  "wsl.onboarding.opencodeReady": "VPS Code er tilbúinn.",
  "wsl.onboarding.installOpencodeIn": "Settu upp VPS Code í {{distro}}.",
  "wsl.onboarding.installOpencode": "Settu upp VPS Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "VPS Code ekki uppsett",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows undirkerfi fyrir Linux) þarf áður en VPS Code getur bætt við WSL netþjóni",
  "wsl.onboarding.wslUnavailable.title": "WSL ekki í boði",
  "wsl.onboarding.wslUnavailable.description": "VPS Code gat ekki staðfest WSL á þessari vél.",
  "wsl.onboarding.installWsl": "Settu upp WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Endurræstu Windows til að klára að setja upp WSL, opnaðu síðan VPS Code aftur.",
  ...
  "help.tabs.introduction": "VPS Code Desktop er nú byggt í kringum flipa.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Ný útgáfa af VPS Code ({{version}}) er nú fáanleg til uppsetningar.",
  ...
  "error.page.report.prefix": "Vinsamlegast tilkynnið þessa villu til VPS Code teymisins",
  ...
  "error.chain.mcpFailed": "MCP þjónn „{{name}}“ mistókst. Athugið, VPS Code styður ekki MCP auðkenningu ennþá.",
  ...
  "sidebar.gettingStarted.line1": "VPS Code inniheldur ókeypis gerðir svo þú getir byrjað strax.",
  ...
  "app.name.desktop": "VPS Code skjáborð",
  ...
  "settings.desktop.wsl.description": "Keyrðu VPS Code netþjóninn inni í WSL á Windows.",
  ...
  "settings.general.row.language.description": "Breyttu skjátungumálinu fyrir VPS Code",
  ...
  "settings.general.row.appearance.description": "Sérsníddu hvernig VPS Code lítur út á tækinu þínu",
  "settings.general.row.colorScheme.title": "Litasamsetning",
  "settings.general.row.colorScheme.description": "Veldu hvort VPS Code fylgir kerfis-, ljósu eða dökku þema",
  "settings.general.row.theme.title": "Þema",
  "settings.general.row.theme.description": "Sérsníddu hvernig VPS Code er þema.",
  ...
  "settings.updates.row.startup.description": "Athugaðu sjálfkrafa fyrir uppfærslur þegar VPS Code ræsir",
  ...
  "settings.updates.toast.latest.description": "Þú ert að keyra nýjustu útgáfuna af VPS Code.",
