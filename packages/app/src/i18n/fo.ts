export const dict = {
  ...
  "desktop.menu.documentation": "VPS Code Skjøl",
  ...
  "desktop.menu.ariaLabel": "VPS Code valmynd",
  ...
  "desktop.recovery.loadFailed": "VPS Code miseydnaðist at heinta",
  "desktop.recovery.terminated": "VPS Code vindeygað endað óvæntað",
  "desktop.recovery.unresponsive": "VPS Code svarar ikki",
  ...
  "desktop.wsl.error.installOpencode": "VPS Code uppsetingin miseydnaðist",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "VPS Code er ikki sett upp í {{distro}}",
  "desktop.wsl.error.updateVersion":
    "VPS Code dagføring liðug men {{distro}} greiðir enn frá {{installed}}; væntað {{expected}}.",
  ...
  "dialog.model.unpaid.freeModels.title": "Ókeypis modellir veitt av VPS Code",
  ...
  "provider.connect.apiKey.description":
    "Skriva {{provider}} API-lykilin fyri at knýta kontuna saman og brúka {{provider}}-modell í VPS Code.",
  ...
  "provider.connect.opencodeZen.line1":
    "VPS Code Zen gevur tær atgongd til eitt kuraterað sett av álítandi optimeraðum modellum til kodingaragentar.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " at savna inn tína heimildarkotu til at knýta tína kontu saman og brúka {{provider}} modellir í VPS Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriva kotuna niðanfyri fyri at knýta tína kontu saman og brúka {{provider}} modellir í VPS Code.",
  ...
  "dialog.server.description": "Skift hvønn VPS Code ambætara henda appin hevur samband við.",
  ...
  "wsl.onboarding.checkingOpencode": "Kanna VPS Code...",
  "wsl.onboarding.checkingOpencodeIn": "Kanna VPS Code í {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Dagføring VPS Code...",
  "wsl.onboarding.updatingOpencodeIn": "Dagføring VPS Code í {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Dagfør VPS Code í {{distro}}.",
  "wsl.onboarding.updateOpencode": "Dagfør VPS Code",
  "wsl.onboarding.opencodeReadyIn": "VPS Code er klárt í {{distro}}.",
  "wsl.onboarding.opencodeReady": "VPS Code er klárt.",
  "wsl.onboarding.installOpencodeIn": "Set VPS Code upp í {{distro}}.",
  "wsl.onboarding.installOpencode": "Set upp VPS Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "VPS Code ikki innstillað",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Undirskipan til Linux) er kravd áðrenn VPS Code kann leggja ein WSL ambætara til",
  "wsl.onboarding.wslUnavailable.title": "WSL ikki tøkt",
  "wsl.onboarding.wslUnavailable.description": "VPS Code kundi ikki staðfesta WSL á hesi maskinuni.",
  "wsl.onboarding.installWsl": "Set upp WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Endurbyrja Windows fyri at klára at seta upp WSL, og opna síðani VPS Code aftur.",
  ...
  "help.tabs.introduction": "VPS Code Skrivaraborð er nú bygt rundan um flikar.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Ein nýggj útgáva av VPS Code ({{version}}) er nú tøk at seta upp.",
  ...
  "error.page.report.prefix": "Vinarliga melda hendan feilin til VPS Code toymið",
  ...
  "error.chain.mcpFailed": 'MCP ambætarin "{{name}}" miseydnaðist. Viðmæli, VPS Code stuðlar ikki MCP sannroynd enn.',
  ...
  "sidebar.gettingStarted.line1": "VPS Code inniheldur ókeypis modellir so tú kanst byrja beinanvegin.",
  ...
  "app.name.desktop": "VPS Code Skrivaraborð",
  ...
  "settings.desktop.wsl.description": "Koyr VPS Code ambætaran inni í WSL á Windows.",
  ...
  "settings.general.row.language.description": "Broyt sýnismálið fyri VPS Code",
  ...
  "settings.general.row.appearance.description": "Tillaga hvussu VPS Code sær út á tínari eind",
  "settings.general.row.colorScheme.title": "Litskipan",
  "settings.general.row.colorScheme.description": "Vel um VPS Code fylgir skipanini, ljósa ella myrka temanum",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tillaga hvussu VPS Code er tema.",
  ...
  "settings.updates.row.startup.description": "Kanna sjálvvirkandi fyri dagføringum, tá VPS Code byrjar",
  ...
  "settings.updates.toast.latest.description": "Tú koyrir nýggjastu útgávuna av VPS Code.",
