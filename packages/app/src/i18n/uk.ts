export const dict = {
  ...
  "desktop.menu.documentation": "Документація VPS Code",
  ...
  "desktop.menu.ariaLabel": "Меню VPS Code",
  ...
  "desktop.recovery.loadFailed": "Не вдалося завантажити VPS Code",
  "desktop.recovery.terminated": "Роботу вікна VPS Code несподівано завершено",
  "desktop.recovery.unresponsive": "VPS Code не відповідає",
  ...
  "desktop.wsl.error.installOpencode": "Не вдалося встановити VPS Code",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "VPS Code не встановлено в {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Оновлення VPS Code завершено, але {{distro}} усе ще повідомляє про версію {{installed}}; очікувалася {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Безкоштовні моделі від VPS Code",
  ...
  "provider.connect.apiKey.description":
    "Введіть ключ API {{provider}}, щоб підключити обліковий запис і використовувати моделі {{provider}} у VPS Code.",
  ...
  "provider.connect.opencodeZen.line1":
    "VPS Code Zen надає доступ до відібраного набору надійних оптимізованих моделей для агентів кодування.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", щоб отримати код авторизації, підключити обліковий запис і використовувати моделі {{provider}} у VPS Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " і введіть код нижче, щоб підключити обліковий запис і використовувати моделі {{provider}} у VPS Code.",
  ...
  "dialog.server.description": "Перемкніть сервер VPS Code, до якого підключається ця програма.",
  ...
  "wsl.onboarding.checkingOpencode": "Перевірка VPS Code...",
  "wsl.onboarding.checkingOpencodeIn": "Перевірка VPS Code у {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Оновлення VPS Code...",
  "wsl.onboarding.updatingOpencodeIn": "Оновлення VPS Code у {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Оновіть VPS Code у {{distro}}.",
  "wsl.onboarding.updateOpencode": "Оновити VPS Code",
  "wsl.onboarding.opencodeReadyIn": "VPS Code готовий до роботи у {{distro}}.",
  "wsl.onboarding.opencodeReady": "VPS Code готовий до роботи.",
  "wsl.onboarding.installOpencodeIn": "Встановіть VPS Code у {{distro}}.",
  "wsl.onboarding.installOpencode": "Встановити VPS Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "VPS Code не встановлено",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Для додавання сервера WSL в VPS Code потрібна WSL (Підсистема Windows для Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL недоступна",
  "wsl.onboarding.wslUnavailable.description": "VPS Code не вдалося перевірити WSL на цьому комп'ютері.",
  "wsl.onboarding.installWsl": "Встановити WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Перезапустіть Windows, щоб завершити встановлення WSL, а потім знову відкрийте VPS Code.",
  ...
  "help.tabs.introduction": "VPS Code Desktop тепер побудовано навколо вкладок.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Нова версія VPS Code ({{version}}) тепер доступна для встановлення.",
  ...
  "error.page.report.prefix": "Будь ласка, повідомте про цю помилку команді VPS Code",
  ...
  "error.chain.mcpFailed":
    'Сервер MCP "{{name}}" не працює. Зверніть увагу, VPS Code ще не підтримує автентифікацію MCP.',
  ...
  "sidebar.gettingStarted.line1": "VPS Code містить безкоштовні моделі, тому ви можете почати негайно.",
  ...
  "settings.desktop.wsl.description": "Запускати сервер VPS Code всередині WSL на Windows.",
  ...
  "settings.general.row.language.description": "Змінити мову інтерфейсу VPS Code",
  ...
  "settings.general.row.appearance.description": "Налаштуйте вигляд VPS Code на вашому пристрої",
  "settings.general.row.colorScheme.title": "Кольорова схема",
  "settings.general.row.colorScheme.description": "Виберіть, чи VPS Code використовує системну, світлу або темну тему",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Налаштуйте тему VPS Code.",
  ...
  "settings.updates.row.startup.description": "Автоматично перевіряти наявність оновлень під час запуску VPS Code",
  ...
  "settings.updates.toast.latest.description": "Ви використовуєте останню версію VPS Code.",
