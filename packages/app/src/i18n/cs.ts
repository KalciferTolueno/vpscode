export const dict = {
  ...
  "desktop.menu.documentation": "VPS Code Dokumentace",
  ...
  "desktop.menu.ariaLabel": "Nabídka VPS Code",
  ...
  "desktop.recovery.loadFailed": "VPS Code se nepodařilo načíst",
  "desktop.recovery.terminated": "VPS Code okno bylo neočekávaně ukončeno",
  "desktop.recovery.unresponsive": "VPS Code nereaguje",
  ...
  "desktop.wsl.error.installOpencode": "VPS Code instalace se nezdařila",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "VPS Code není nainstalován v {{distro}}",
  "desktop.wsl.error.updateVersion":
    "VPS Code aktualizace dokončena, ale {{distro}} stále hlásí {{installed}}; očekává se {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Zadejte klíč API služby {{provider}}, připojte účet a používejte modely {{provider}} v VPS Code.",
  ...
  "provider.connect.opencodeZen.line1":
    "VPS Code Zen vám poskytuje přístup k upravené sadě spolehlivých optimalizovaných modelů pro kódovací agenty.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " k vyzvednutí autorizačního kódu pro připojení vašeho účtu a používání {{provider}} modelů v VPS Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " a zadejte níže uvedený kód pro připojení svého účtu a používání {{provider}} modelů v VPS Code.",
  ...
  "dialog.server.description": "Přepněte, ke kterému VPS Code serveru se tato aplikace připojuje.",
  ...
  "wsl.onboarding.checkingOpencode": "Kontrola VPS Code...",
  "wsl.onboarding.checkingOpencodeIn": "Kontrola VPS Code v {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Aktualizace VPS Code...",
  "wsl.onboarding.updatingOpencodeIn": "Aktualizace VPS Code v {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Aktualizace VPS Code v {{distro}}.",
  "wsl.onboarding.updateOpencode": "Aktualizovat VPS Code",
  "wsl.onboarding.opencodeReadyIn": "VPS Code je připraveno v {{distro}}.",
  "wsl.onboarding.opencodeReady": "VPS Code je připraven.",
  "wsl.onboarding.installOpencodeIn": "Nainstalujte VPS Code do {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalovat VPS Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "VPS Code není nainstalováno",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystém pro Linux) je vyžadován předtím, než VPS Code může přidat server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL není k dispozici",
  "wsl.onboarding.wslUnavailable.description": "VPS Code nemohl ověřit WSL na tomto počítači.",
  "wsl.onboarding.installWsl": "Instalovat WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Restartujte Windows pro dokončení instalace WSL a poté znovu otevřete VPS Code.",
  ...
  "help.tabs.introduction": "VPS Code Plocha je nyní postavena na kartách.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nyní je k dispozici k instalaci nová verze VPS Code ({{version}}).",
  ...
  "error.page.report.prefix": "Nahlaste tuto chybu týmu VPS Code",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" selhal. Poznámka: VPS Code zatím nepodporuje ověřování MCP.',
  ...
  "sidebar.gettingStarted.line1": "VPS Code obsahuje bezplatné modely, takže můžete začít okamžitě.",
  ...
  "settings.desktop.wsl.description": "Spusťte server VPS Code uvnitř WSL na Windows.",
  ...
  "settings.general.row.language.description": "Změnit jazyk zobrazení pro VPS Code",
  ...
  "settings.general.row.appearance.description": "Přizpůsobte si vzhled VPS Code na vašem zařízení",
  "settings.general.row.colorScheme.title": "Barevné schéma",
  "settings.general.row.colorScheme.description":
    "Zvolte, zda bude VPS Code následovat systémové, světlé nebo tmavé téma",
  "settings.general.row.theme.title": "téma",
  "settings.general.row.theme.description": "Přizpůsobte, jak je téma VPS Code.",
  ...
  "settings.updates.row.startup.description": "Automaticky kontrolovat aktualizace při spuštění VPS Code",
  ...
  "settings.updates.toast.latest.description": "Používáte nejnovější verzi VPS Code.",
