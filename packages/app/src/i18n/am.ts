export const dict = {
  ...
  "desktop.recovery.loadFailed": "VPS Code መጫን አልቻለም",
  "desktop.recovery.terminated": "VPS Code መስኮት በድንገት ተቋርጧል",
  "desktop.recovery.unresponsive": "VPS Code ምላሽ እየሰጠ አይደለም",
  ...
  "desktop.wsl.error.installOpencode": "VPS Codeመጫኑ አልተሳካም",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "VPS Code በ{{distro}}] ውስጥ አልተጫነም",
  "desktop.wsl.error.updateVersion":
    "VPS Code ዝማኔ አልቋል ግን {{distro}} አሁንም ሪፖርት ያደርጋል {{installed}}; የሚጠበቀው {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "ነጻ ሞዴሎች በVPS Code",
  ...
  "provider.connect.apiKey.description":
    "መለያዎን ለማገናኘት የ{{provider}} API ቁልፍዎን ያስገቡ እና {{provider}} ሞዴሎችን በVPS Code ይጠቀሙ።",
  ...
  "provider.connect.opencodeZen.line1": "VPS Code ዜን ለኮድ ወኪሎች የተመቻቹ አስተማማኝ ሞዴሎች ስብስብ መዳረሻ ይሰጥዎታል።",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " መለያዎን ለማገናኘት የፈቀዳ ኮድዎን ለመሰብሰብ እና {{provider}} ሞዴሎችን በVPS Code ውስጥ ይጠቀሙ።",
  ...
  "provider.connect.oauth.auto.visit.suffix": " እና መለያዎን ለማገናኘት ከታች ያለውን ኮድ ያስገቡ እና {{provider}} ሞዴሎችን በVPS Code ይጠቀሙ።",
  ...
  "dialog.server.description": "ይህ መተግበሪያ ከየትኛው VPS Code አገልጋይ ጋር እንደሚገናኝ ይቀይሩ።",
  ...
  "wsl.onboarding.checkingOpencode": "መፈተሽ VPS Code...",
  "wsl.onboarding.checkingOpencodeIn": "VPS Codeን በ{{distro}} ውስጥ በመፈተሽ ላይ...",
  "wsl.onboarding.updatingOpencode": "በማዘመን ላይ VPS Code...",
  "wsl.onboarding.updatingOpencodeIn": "በማዘመን ላይ VPS Code በ{{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "አዘምን VPS Code በ{{distro}}።",
  "wsl.onboarding.updateOpencode": "አዘምን VPS Code",
  "wsl.onboarding.opencodeReadyIn": "VPS Code በ{{distro}} ውስጥ ዝግጁ ነው።",
  "wsl.onboarding.opencodeReady": "VPS Code ዝግጁ ነው።",
  "wsl.onboarding.installOpencodeIn": "መጫን VPS Code በ{{distro}} ውስጥ።",
  "wsl.onboarding.installOpencode": "ጫን VPS Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "VPS Codeአልተጫነም",
  ...
  "wsl.onboarding.wslNotInstalled.description": "WSL (Windowsንዑስ ስርዓት ለLinux) VPS Code WSL አገልጋይ ከመጨመራቸው በፊት ያስፈልጋል",
  "wsl.onboarding.wslUnavailable.title": "WSL አይገኝም",
  "wsl.onboarding.wslUnavailable.description": "VPS Code በዚህ ማሽን ላይ WSLን ማረጋገጥ አልቻለም።",
  "wsl.onboarding.installWsl": "ጫን WSL",
  "wsl.onboarding.windowsRestartRequired": "WSLን መጫኑን ለመጨረስ Windows እንደገና ያስጀምሩ እና ከዚያ እንደገና ይክፈቱ VPS Code።",
  ...
  "help.tabs.introduction": "VPS Code ዴስክቶፕ አሁን በትሮች ዙሪያ ነው የተሰራው።",
  "help.tabs.sessions":
  ...
  "toast.update.description": "አዲሱ የVPS Code ({{version}}) ስሪት አሁን ለመጫን አለ።",
  ...
  "error.page.report.prefix": "እባክዎ ይህንን ስህተት ለVPS Code ቡድን ያሳውቁ",
  ...
  "error.chain.mcpFailed": 'MCP አገልጋይ "{{name}}" አልተሳካም። ማስታወሻ፣ VPS Code እስካሁን MCP ማረጋገጫን አይደግፍም።',
  ...
  "sidebar.gettingStarted.line1": "VPS Code ነፃ ሞዴሎችን ያካትታል ስለዚህ ወዲያውኑ መጀመር ይችላሉ።",
  ...
  "app.name.desktop": "VPS Code ዴስክቶፕ",
  ...
  "settings.desktop.wsl.description": "የVPS Code አገልጋዩን በWSL ውስጥ በWindows ላይ ያሂዱ።",
  ...
  "settings.general.row.language.description": "የማሳያ ቋንቋውን ለVPS Code",
  ...
  "settings.general.row.appearance.description": "VPS Codeበመሣሪያዎ ላይ እንዴት እንደሚታይ ብጁ ያድርጉ",
  "settings.general.row.colorScheme.title": "የቀለም ንድፍ",
  "settings.general.row.colorScheme.description": "VPS Code ስርዓቱን፣ ብርሃንን ወይም ጨለማውን ገጽታ የሚከተል እንደሆነ ምረጥ",
  "settings.general.row.theme.title": "ገጽታ",
  "settings.general.row.theme.description": "VPS Code ገጽታ እንዴት እንደሆነ አብጅ።",
  ...
  "settings.updates.row.startup.description": "VPS Code ሲጀመር ዝማኔዎችን በራስ-ሰር ያረጋግጡ",
  ...
  "settings.updates.toast.latest.description": "የቅርብ ጊዜውን የVPS Code እትም እያሄዱ ነው።",
