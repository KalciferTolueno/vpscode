export const dict = {
  ...
  "desktop.menu.documentation": "Tài liệu VPS Code",
  ...
  "desktop.recovery.loadFailed": "Không tải được VPS Code",
  "desktop.recovery.terminated": "Cửa sổ VPS Code đã bị đóng đột ngột",
  "desktop.recovery.unresponsive": "VPS Code không phản hồi",
  ...
  "desktop.wsl.error.installOpencode": "Không cài đặt được VPS Code",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "VPS Code chưa được cài đặt trong {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Đã cập nhật VPS Code nhưng {{distro}} vẫn báo phiên bản {{installed}}; phiên bản dự kiến là {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Các mô hình miễn phí do VPS Code cung cấp",
  ...
  "provider.connect.apiKey.description":
    "Nhập khóa API {{provider}} để kết nối tài khoản và sử dụng các mô hình {{provider}} trong VPS Code.",
  ...
  "provider.connect.opencodeZen.line1":
    "VPS Code Zen cho phép bạn truy cập một bộ mô hình được tuyển chọn, tối ưu hóa và đáng tin cậy dành cho tác nhân lập trình.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " để lấy mã ủy quyền, kết nối tài khoản và sử dụng các mô hình {{provider}} trong VPS Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " và nhập mã bên dưới để kết nối tài khoản của bạn và sử dụng các mô hình {{provider}} trong VPS Code.",
  ...
  "dialog.server.description": "Chuyển máy chủ VPS Code mà ứng dụng này kết nối tới.",
  ...
  "wsl.onboarding.checkingOpencode": "Đang kiểm tra VPS Code...",
  "wsl.onboarding.checkingOpencodeIn": "Đang kiểm tra VPS Code trong {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Đang cập nhật VPS Code...",
  "wsl.onboarding.updatingOpencodeIn": "Đang cập nhật VPS Code trong {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Cập nhật VPS Code trong {{distro}}.",
  "wsl.onboarding.updateOpencode": "Cập nhật VPS Code",
  "wsl.onboarding.opencodeReadyIn": "VPS Code đã sẵn sàng trong {{distro}}.",
  "wsl.onboarding.opencodeReady": "VPS Code đã sẵn sàng.",
  "wsl.onboarding.installOpencodeIn": "Cài đặt VPS Code trong {{distro}}.",
  "wsl.onboarding.installOpencode": "Cài đặt VPS Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "VPS Code chưa được cài đặt",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Cần có WSL (Hệ thống con Windows dành cho Linux) trước khi VPS Code có thể thêm máy chủ WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL không có sẵn",
  "wsl.onboarding.wslUnavailable.description": "VPS Code không thể xác minh WSL trên máy này.",
  "wsl.onboarding.installWsl": "Cài đặt WSL",
  "wsl.onboarding.windowsRestartRequired": "Khởi động lại Windows để hoàn tất cài đặt WSL, sau đó mở lại VPS Code.",
  ...
  "help.tabs.introduction": "VPS Code Desktop nay được xây dựng xoay quanh các tab.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Hiện đã có phiên bản mới của VPS Code ({{version}}) để cài đặt.",
  ...
  "error.page.report.prefix": "Vui lòng báo cáo lỗi này cho nhóm VPS Code",
  ...
  "error.chain.mcpFailed": 'Máy chủ MCP "{{name}}" gặp lỗi. Lưu ý: VPS Code chưa hỗ trợ xác thực MCP.',
  ...
  "sidebar.gettingStarted.line1": "VPS Code bao gồm các mô hình miễn phí để bạn có thể bắt đầu ngay lập tức.",
  ...
  "settings.desktop.wsl.description": "Chạy máy chủ VPS Code bên trong WSL trên Windows.",
  ...
  "settings.general.row.language.description": "Thay đổi ngôn ngữ hiển thị cho VPS Code",
  ...
  "settings.general.row.appearance.description": "Tùy chỉnh giao diện của VPS Code trên thiết bị",
  "settings.general.row.colorScheme.title": "Cách phối màu",
  "settings.general.row.colorScheme.description": "Chọn xem VPS Code tuân theo hệ thống, chủ đề sáng hay tối",
  "settings.general.row.theme.title": "Chủ đề",
  "settings.general.row.theme.description": "Tùy chỉnh chủ đề của VPS Code.",
  ...
  "settings.updates.row.startup.description": "Tự động kiểm tra các bản cập nhật khi VPS Code khởi chạy",
  ...
  "settings.updates.toast.latest.description": "Bạn đang chạy phiên bản mới nhất của VPS Code.",
