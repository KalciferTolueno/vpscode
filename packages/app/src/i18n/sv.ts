export const dict = {
  ...
  "desktop.recovery.loadFailed": "VPS Code kunde inte läsas in",
  "desktop.recovery.terminated": "VPS Code-fönstret avslutades oväntat",
  "desktop.recovery.unresponsive": "VPS Code svarar inte",
  ...
  "desktop.wsl.error.installOpencode": "Installationen av VPS Code misslyckades",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "VPS Code är inte installerat i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "VPS Code-uppdateringen slutfördes, men {{distro}} rapporterar fortfarande {{installed}}. {{expected}} förväntades",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller tillhandahålls av VPS Code",
  ...
  "provider.connect.apiKey.description":
    "Ange din {{provider}}-API-nyckel för att ansluta ditt konto och använda {{provider}}-modeller i VPS Code.",
  ...
  "provider.connect.opencodeZen.line1":
    "VPS Code Zen ger dig tillgång till en utvald uppsättning pålitliga optimerade modeller för kodningsagenter.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " för att hämta auktoriseringskoden som ansluter ditt konto och låter dig använda {{provider}}-modeller i VPS Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " och ange koden nedan för att ansluta ditt konto och använda {{provider}}-modeller i VPS Code.",
  ...
  "dialog.server.description": "Växla vilken VPS Code-server som denna app ansluter till.",
  ...
  "wsl.onboarding.checkingOpencode": "Kontrollerar VPS Code...",
  "wsl.onboarding.checkingOpencodeIn": "Kontrollerar VPS Code i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Uppdaterar VPS Code...",
  "wsl.onboarding.updatingOpencodeIn": "Uppdaterar VPS Code i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Uppdatera VPS Code i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Uppdatera VPS Code",
  "wsl.onboarding.opencodeReadyIn": "VPS Code är redo i {{distro}}.",
  "wsl.onboarding.opencodeReady": "VPS Code är redo.",
  "wsl.onboarding.installOpencodeIn": "Installera VPS Code i {{distro}}.",
  "wsl.onboarding.installOpencode": "Installera VPS Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "VPS Code är inte installerat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) krävs innan VPS Code kan lägga till en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL är inte tillgängligt",
  "wsl.onboarding.wslUnavailable.description": "VPS Code kunde inte verifiera WSL på den här maskinen.",
  "wsl.onboarding.installWsl": "Installera WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Starta om Windows för att slutföra installationen av WSL och öppna sedan VPS Code igen.",
  ...
  "help.tabs.introduction": "VPS Code Desktop är nu uppbyggt kring flikar.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "En ny version av VPS Code ({{version}}) är nu tillgänglig att installera.",
  ...
  "error.page.report.prefix": "Rapportera det här felet till VPS Code-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-servern "{{name}}" misslyckades. Obs, VPS Code stöder inte MCP-autentisering ännu.',
  ...
  "sidebar.gettingStarted.line1": "VPS Code innehåller gratis modeller så att du kan börja direkt.",
  ...
  "settings.desktop.wsl.description": "Kör VPS Code-servern inuti WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ändra visningsspråket för VPS Code",
  ...
  "settings.general.row.appearance.description": "Anpassa hur VPS Code ser ut på din enhet",
  "settings.general.row.colorScheme.title": "Färgschema",
  "settings.general.row.colorScheme.description": "Välj om VPS Code följer system-, ljus- eller mörktemat",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Anpassa VPS Codes tema.",
  ...
  "settings.updates.row.startup.description": "Sök automatiskt efter uppdateringar när VPS Code startas",
  ...
  "settings.updates.toast.latest.description": "Du kör den senaste versionen av VPS Code.",
