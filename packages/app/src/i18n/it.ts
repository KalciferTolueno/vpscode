export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modelli gratuiti forniti da VPS Code",
  ...
  "provider.connect.apiKey.description":
    "Inserisci la chiave API di {{provider}} per connettere il tuo account e utilizzare i modelli {{provider}} in VPS Code.",
  ...
  "provider.connect.opencodeZen.line1":
    "VPS Code Zen offre l'accesso a una selezione di modelli affidabili e ottimizzati per gli agenti di programmazione.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " per ottenere il codice di autorizzazione, connettere il tuo account e usare i modelli {{provider}} in VPS Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e inserisci il codice qui sotto per connettere il tuo account e usare i modelli {{provider}} in VPS Code.",
  ...
  "dialog.server.description": "Cambia il server VPS Code a cui si connette l'app.",
  ...
  "wsl.onboarding.checkingOpencode": "Controllo VPS Code...",
  "wsl.onboarding.checkingOpencodeIn": "Controllo VPS Code in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Aggiornamento VPS Code...",
  "wsl.onboarding.updatingOpencodeIn": "Aggiornamento VPS Code in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Aggiorna VPS Code in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Aggiorna VPS Code",
  "wsl.onboarding.opencodeReadyIn": "VPS Code è pronto in {{distro}}.",
  "wsl.onboarding.opencodeReady": "VPS Code è pronto.",
  "wsl.onboarding.installOpencodeIn": "Installa VPS Code in {{distro}}.",
  "wsl.onboarding.installOpencode": "Installa VPS Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "VPS Code non installato",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Sottosistema Windows per Linux) è necessario prima che VPS Code possa aggiungere un server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL non disponibile",
  "wsl.onboarding.wslUnavailable.description": "VPS Code non ha potuto verificare WSL su questa macchina.",
  "wsl.onboarding.installWsl": "Installa WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Riavvia Windows per completare l'installazione WSL, quindi riapri VPS Code.",
  ...
  "help.tabs.introduction": "VPS Code Desktop ora è incentrato sulle schede.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nuova versione di VPS Code ({{version}}) è ora disponibile per l'installazione.",
  ...
  "error.page.report.prefix": "Segnala questo errore al team VPS Code",
  ...
  "error.chain.mcpFailed":
    'Il server MCP "{{name}}" non ha funzionato. Nota: VPS Code non supporta ancora l\'autenticazione MCP.',
  ...
  "sidebar.gettingStarted.line1": "VPS Code include modelli gratuiti così puoi iniziare immediatamente.",
  ...
  "settings.desktop.wsl.description": "Esegui il server VPS Code all'interno di WSL su Windows.",
  ...
  "settings.general.row.language.description": "Cambia la lingua di visualizzazione per VPS Code",
  ...
  "settings.general.row.appearance.description": "Personalizza l'aspetto di VPS Code sul tuo dispositivo",
  "settings.general.row.colorScheme.title": "Combinazione di colori",
  "settings.general.row.colorScheme.description": "Scegli se VPS Code segue il tema di sistema, chiaro o scuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalizza il tema di VPS Code.",
  ...
  "settings.updates.row.startup.description": "Controlla automaticamente gli aggiornamenti all'avvio di VPS Code",
  ...
  "settings.updates.toast.latest.title": "VPS Code è aggiornato",
  "settings.updates.toast.latest.description": "Stai utilizzando l'ultima versione di VPS Code.",
  ...
  "desktop.menu.documentation": "Documentazione di VPS Code",
  ...
  "desktop.menu.ariaLabel": "Menu VPS Code",
  ...
  "desktop.recovery.loadFailed": "Impossibile caricare VPS Code",
  "desktop.recovery.terminated": "La finestra di VPS Code si è chiusa in modo imprevisto",
  "desktop.recovery.unresponsive": "VPS Code non risponde",
  ...
  "desktop.wsl.error.installOpencode": "Installazione di VPS Code non riuscita",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "VPS Code non è installato in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "L'aggiornamento di VPS Code è terminato, ma {{distro}} segnala ancora la versione {{installed}}; era prevista la versione {{expected}}",
