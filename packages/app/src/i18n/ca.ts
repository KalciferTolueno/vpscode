export const dict = {
  ...
  "desktop.menu.documentation": "VPS Code Documentació",
  ...
  "desktop.menu.ariaLabel": "menú VPS Code.",
  ...
  "desktop.recovery.loadFailed": "VPS Code no s'ha pogut carregar",
  "desktop.recovery.terminated": "La finestra VPS Code s'ha acabat inesperadament",
  "desktop.recovery.unresponsive": "VPS Code no respon",
  ...
  "desktop.wsl.error.installOpencode": "La instal·lació de VPS Code ha fallat",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "VPS Code no està instal·lat a {{distro}}",
  "desktop.wsl.error.updateVersion":
    "VPS Code actualització acabada però {{distro}} encara informa {{installed}}; esperat {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Models gratuïts proporcionats per VPS Code",
  ...
  "provider.connect.apiKey.description":
    "Introduïu la clau API de {{provider}} per connectar el compte i utilitzar els models de {{provider}} a VPS Code.",
  ...
  "provider.connect.opencodeZen.line1":
    "VPS Code Zen us ofereix accés a un conjunt seleccionat de models optimitzats fiables per a agents de codificació.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " per recollir el vostre codi d'autorització per connectar el vostre compte i utilitzar {{provider}} models a VPS Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i introduïu el codi següent per connectar el vostre compte i utilitzar {{provider}} models a VPS Code.",
  ...
  "dialog.server.description": "Canvia a quin VPS Code servidor es connecta aquesta aplicació.",
  ...
  "wsl.onboarding.checkingOpencode": "S'està comprovant VPS Code...",
  "wsl.onboarding.checkingOpencodeIn": "S'està registrant VPS Code a {{distro}}...",
  "wsl.onboarding.updatingOpencode": "S'està actualitzant VPS Code...",
  "wsl.onboarding.updatingOpencodeIn": "S'està actualitzant VPS Code a {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Actualitza VPS Code a {{distro}}.",
  "wsl.onboarding.updateOpencode": "Actualització VPS Code",
  "wsl.onboarding.opencodeReadyIn": "VPS Code està llest a {{distro}}.",
  "wsl.onboarding.opencodeReady": "VPS Code està llest.",
  "wsl.onboarding.installOpencodeIn": "Instal·leu VPS Code a {{distro}}.",
  "wsl.onboarding.installOpencode": "Instal·la VPS Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "VPS Code no instal·lat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsistema per a Linux) és necessari abans que VPS Code pugui afegir un WSL servidor",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "VPS Code no ha pogut verificar WSL en aquesta màquina.",
  "wsl.onboarding.installWsl": "Instal·la WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicieu Windows per acabar d'instal·lar WSL i, a continuació, torneu a obrir VPS Code.",
  ...
  "help.tabs.introduction": "VPS Code L'escriptori ara està construït al voltant de pestanyes.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nova versió de VPS Code ({{version}}) ja està disponible per instal·lar-la.",
  ...
  "error.page.report.prefix": "Informeu aquest error a l'equip VPS Code.",
  ...
  "error.chain.mcpFailed":
    'El servidor MCP "{{name}}" ha fallat. Tingueu en compte que VPS Code encara no admet l\'autenticació MCP.',
  ...
  "sidebar.gettingStarted.line1": "VPS Code inclou models gratuïts perquè pugueu començar immediatament.",
  ...
  "app.name.desktop": "VPS Code Escriptori",
  ...
  "settings.desktop.wsl.description": "Executeu el servidor VPS Code dins de WSL a Windows.",
  ...
  "settings.general.row.language.description": "Canvia l'idioma de visualització per a VPS Code",
  ...
  "settings.general.row.appearance.description": "Personalitza com es veu VPS Code al teu dispositiu",
  "settings.general.row.colorScheme.title": "Esquema de colors",
  "settings.general.row.colorScheme.description": "Trieu si VPS Code segueix el tema del sistema, clar o fosc",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalitza la temàtica de VPS Code.",
  ...
  "settings.updates.row.startup.description":
    "Comprova automàticament si hi ha actualitzacions quan s'iniciï VPS Code.",
  ...
  "settings.updates.toast.latest.description": "Esteu executant la darrera versió de VPS Code.",
