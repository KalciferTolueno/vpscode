export const dict = {
  ...
  "desktop.menu.documentation": "VPS Code Resminamalar",
  ...
  "desktop.menu.ariaLabel": "VPS Code menýusy",
  ...
  "desktop.recovery.loadFailed": "VPS Code ýükläp bilmedi",
  "desktop.recovery.terminated": "VPS Code penjiresi garaşylmadyk ýagdaýda bes edildi",
  "desktop.recovery.unresponsive": "VPS Code jogap berenok",
  ...
  "desktop.wsl.error.installOpencode": "VPS Code gurmak şowsuz",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "VPS Code {{distro}} gurulmady",
  "desktop.wsl.error.updateVersion":
    "VPS Code täzelenmesi gutardy, ýöne {{distro}} henizem {{installed}} habar berýär; garaşylýan {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "VPS Code tarapyndan mugt modeller",
  ...
  "provider.connect.apiKey.description":
    "Hasabyňyzy birikdirmek we VPS Code-da {{provider}} modellerini ulanmak üçin {{provider}} API açaryňyzy giriziň.",
  ...
  "provider.connect.opencodeZen.line1":
    "VPS Code Zen kodlaşdyrmak serişdeleri üçin ygtybarly optimallaşdyrylan modelleriň toplumyna girmäge mümkinçilik berýär.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " hasabyňyzy birikdirmek we {{provider}} modellerini VPS Code-de ulanmak üçin ygtyýarnama koduňyzy ýygnamak.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " hasabyňyzy birikdirmek we {{provider}} modellerini VPS Code-de ulanmak üçin aşakdaky kody giriziň.",
  ...
  "dialog.server.description": "Bu programmanyň haýsy VPS Code serwerine birikýändigini üýtgediň.",
  ...
  "wsl.onboarding.checkingOpencode": "VPS Code barlamak ...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} içinde VPS Code barlanýar...",
  "wsl.onboarding.updatingOpencode": "VPS Code täzelenmek ...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}-de VPS Code täzelenmek ...",
  "wsl.onboarding.updateOpencodeIn": "VPS Code-ni {{distro}}-de täzeläň.",
  "wsl.onboarding.updateOpencode": "VPS Code täzeläň",
  "wsl.onboarding.opencodeReadyIn": "VPS Code {{distro}}-de taýýar.",
  "wsl.onboarding.opencodeReady": "VPS Code taýýar.",
  "wsl.onboarding.installOpencodeIn": "{{distro}}-de VPS Code guruň.",
  "wsl.onboarding.installOpencode": "VPS Code guruň",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "VPS Code gurulmady",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Linux üçin Windows kiçi ulgamy) VPS Code WSL serwerini goşmazdan ozal talap edilýär",
  "wsl.onboarding.wslUnavailable.title": "WSL elýeterli däl",
  "wsl.onboarding.wslUnavailable.description": "VPS Code bu enjamda WSL barlap bilmedi.",
  "wsl.onboarding.installWsl": "WSL guruň",
  "wsl.onboarding.windowsRestartRequired": "WSL gurnamagy gutarmak üçin Windows-i täzeden açyň, soňra VPS Code açyň.",
  ...
  "help.tabs.introduction": "VPS Code Desktop indi goýmalaryň töwereginde guruldy.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Indi gurmak üçin VPS Code ({{version}}) -iň täze wersiýasy bar.",
  ...
  "error.page.report.prefix": "Bu ýalňyşlygy VPS Code toparyna habar bermegiňizi haýyş edýäris",
  ...
  "error.chain.mcpFailed": 'MCP serweri "{{name}}" şowsuz. Üns beriň, VPS Code entek MCP tassyklamasyny goldamaýar.',
  ...
  "sidebar.gettingStarted.line1": "VPS Code mugt modelleri öz içine alýar, derrew başlap bilersiňiz.",
  ...
  "settings.desktop.wsl.description": "VPS Code serwerini WSL-de Windows-de işlediň.",
  ...
  "settings.general.row.language.description": "VPS Code üçin displeý dilini üýtgediň",
  ...
  "settings.general.row.appearance.description": "VPS Code enjamyňyzda nähili görünýändigini düzüň",
  "settings.general.row.colorScheme.title": "Reňk shemasy",
  "settings.general.row.colorScheme.description":
    "VPS Code ulgamy, ýagtylygy ýa-da garaňky temany yzarlaýandygyny saýlaň",
  "settings.general.row.theme.title": "Mowzuk",
  "settings.general.row.theme.description": "VPS Code-iň mowzuklydygyny düzüň.",
  ...
  "settings.updates.row.startup.description": "VPS Code işe başlanda täzelenmeleri awtomatiki barlaň",
  ...
  "settings.updates.toast.latest.description": "VPS Code-iň iň soňky wersiýasyny işleýärsiňiz.",
