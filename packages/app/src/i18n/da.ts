export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af VPS Code",
  ...
  "provider.connect.apiKey.description":
    "Indtast din API-nøgle til {{provider}} for at forbinde din konto og bruge modeller fra {{provider}} i VPS Code.",
  ...
  "provider.connect.opencodeZen.line1":
    "VPS Code Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode, forbinde din konto og bruge modeller fra {{provider}} i VPS Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge modeller fra {{provider}} i VPS Code.",
  ...
  "dialog.server.description": "Skift hvilken VPS Code-server denne app forbinder til.",
  ...
  "wsl.onboarding.checkingOpencode": "Tjekker VPS Code...",
  "wsl.onboarding.checkingOpencodeIn": "Tjekker VPS Code i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Opdaterer VPS Code...",
  "wsl.onboarding.updatingOpencodeIn": "Opdaterer VPS Code i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Opdater VPS Code i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Opdater VPS Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "VPS Code er ikke installeret",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) er påkrævet, før VPS Code kan tilføje en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er ikke tilgængelig",
  "wsl.onboarding.wslUnavailable.description": "VPS Code kunne ikke bekræfte WSL på denne maskine.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Genstart Windows for at fuldføre installationen af WSL, og åbn derefter VPS Code igen.",
  ...
  "toast.update.description": "En ny version af VPS Code ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til VPS Code-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, VPS Code understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "VPS Code inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør VPS Code-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for VPS Code",
  ...
  "settings.general.row.appearance.description": "Tilpas hvordan VPS Code ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description":
    "Vælg, om VPS Code skal følge systemtemaet eller bruge et lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas VPS Codes tema.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når VPS Code starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af VPS Code.",
  ...
  "desktop.recovery.loadFailed": "VPS Code kunne ikke indlæses",
  "desktop.recovery.terminated": "VPS Code-vinduet blev uventet afsluttet",
  ...
  "desktop.wsl.error.installOpencode": "Installationen af VPS Code mislykkedes",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "VPS Code er ikke installeret i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Opdateringen af VPS Code er fuldført, men {{distro}} rapporterer stadig {{installed}}. Forventet: {{expected}}",
  ...
  "help.tabs.introduction": "VPS Code Desktop er nu bygget op omkring faner.",
  "help.tabs.sessions":
