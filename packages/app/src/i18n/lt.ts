...
const desktop = [
  ...
  "Laukti toliau",
  "Baigti darbą",
  "VPS Code įkelti nepavyko",
  "VPS Code langas netikėtai užsidarė",
  "VPS Code neatsako",
  ...
  "VPS Code įdiegti nepavyko",
  "{{distro}} jau pridėtas",
  "opencode šiame distributyve neįdiegtas",
  "opencode įdiegtas, bet jo paleisti nepavyko",
  "VPS Code neįdiegtas distributyve {{distro}}",
  "VPS Code naujinimas baigtas, bet {{distro}} vis dar praneša {{installed}}; tikėtasi {{expected}}",
  "versijos nėra",
...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Nemokami VPS Code modeliai",
  ...
  "provider.connect.apiKey.description":
    "Įveskite {{provider}} API raktą, kad susietumėte paskyrą ir naudotumėte {{provider}} modelius programoje VPS Code.",
  ...
  "provider.connect.opencodeZen.line1":
    "VPS Code Zen suteikia prieigą prie kuruojamo patikimų optimizuotų kodavimo agentų modelių rinkinio.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "rinkti prieigos kodą, kad galėtumėte prisijungti prie paskyros ir naudoti {{provider}} modelius VPS Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "ir įveskite toliau esantį kodą, kad susietumėte paskyrą ir naudotumėte {{provider}} modelius VPS Code.",
  ...
  "dialog.server.description": "Perjunkite, prie kurio VPS Code serverio jungiasi ši programa.",
  ...
  "wsl.onboarding.checkingOpencode": "Tikrinama VPS Code...",
  "wsl.onboarding.checkingOpencodeIn": "Tikrinama VPS Code {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Atnaujinamas VPS Code...",
  "wsl.onboarding.updatingOpencodeIn": "Atnaujinamas VPS Code {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Atnaujinkite VPS Code {{distro}}.",
  "wsl.onboarding.updateOpencode": "Atnaujinkite VPS Code",
  "wsl.onboarding.opencodeReadyIn": "VPS Code yra paruoštas {{distro}}.",
  "wsl.onboarding.opencodeReady": "VPS Code yra paruoštas.",
  "wsl.onboarding.installOpencodeIn": "Įdiekite VPS Code į {{distro}}.",
  "wsl.onboarding.installOpencode": "Įdiekite VPS Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "VPS Code neįdiegtas",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Kad VPS Code galėtų pridėti WSL serverį, reikalingas WSL (Windows posistemis, skirtas Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL nepasiekiamas",
  "wsl.onboarding.wslUnavailable.description": "VPS Code nepavyko patikrinti WSL šiame įrenginyje.",
  "wsl.onboarding.installWsl": "Įdiekite WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Iš naujo paleiskite Windows, kad užbaigtumėte WSL diegimą, tada iš naujo atidarykite VPS Code.",
  ...
  "help.tabs.introduction": "VPS Code Desktop dabar sukurtas iš skirtukų.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Dabar galima įdiegti naują VPS Code ({{version}}) versiją.",
  ...
  "error.page.report.prefix": "Praneškite apie šią klaidą VPS Code komandai",
  ...
  "error.chain.mcpFailed":
    "MCP serveris „{{name}}“ nepavyko. Atminkite, kad VPS Code dar nepalaiko MCP autentifikavimo.",
  ...
  "sidebar.gettingStarted.line1": "VPS Code apima nemokamus modelius, todėl galite pradėti iš karto.",
  ...
  "app.name.desktop": "VPS Code darbalaukis",
  ...
  "settings.desktop.wsl.description": "Paleiskite VPS Code serverį WSL viduje Windows.",
  ...
  "settings.general.row.language.description": "Pakeiskite VPS Code ekrano kalbą",
  ...
  "settings.general.row.appearance.description": "Tinkinkite, kaip VPS Code atrodo jūsų įrenginyje",
  "settings.general.row.colorScheme.title": "Spalvų schema",
  "settings.general.row.colorScheme.description": "Pasirinkite, ar VPS Code seka sistemos, šviesios ar tamsios temos",
  "settings.general.row.theme.title": "tema",
  "settings.general.row.theme.description": "Tinkinkite VPS Code temą.",
  ...
  "settings.updates.row.startup.description": "Automatiškai patikrinkite, ar nėra naujinimų, kai paleidžiamas VPS Code",
  ...
  "settings.updates.toast.latest.description": "Naudojate naujausią VPS Code versiją.",
