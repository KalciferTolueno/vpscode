export const dict = {
  ...
  "desktop.menu.documentation": "Documentación de VPS Code",
  ...
  "desktop.menu.ariaLabel": "Menú de VPS Code",
  ...
  "desktop.recovery.loadFailed": "No se pudo cargar VPS Code",
  "desktop.recovery.terminated": "La ventana de VPS Code se cerró de forma inesperada",
  "desktop.recovery.unresponsive": "VPS Code no responde",
  ...
  "desktop.wsl.error.installOpencode": "No se pudo instalar VPS Code",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "VPS Code no está instalado en {{distro}}",
  "desktop.wsl.error.updateVersion":
    "La actualización de VPS Code finalizó, pero {{distro}} sigue indicando {{installed}}; se esperaba {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por VPS Code",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en VPS Code.",
  ...
  "provider.connect.opencodeZen.line1":
    "VPS Code Zen te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programación.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en VPS Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en VPS Code.",
  ...
  "file.saveFailed": "No se pudo guardar el archivo",
  ...
  "dialog.server.description": "Cambiar el servidor de VPS Code al que se conecta esta aplicación.",
  ...
  "wsl.onboarding.step.opencode": "VPS Code",
  ...
  "wsl.onboarding.checkingOpencode": "Comprobando VPS Code...",
  "wsl.onboarding.checkingOpencodeIn": "Comprobando VPS Code en {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Actualizando VPS Code...",
  "wsl.onboarding.updatingOpencodeIn": "Actualizando VPS Code en {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Actualiza VPS Code en {{distro}}.",
  "wsl.onboarding.updateOpencode": "Actualizar VPS Code",
  "wsl.onboarding.opencodeReadyIn": "VPS Code está listo en {{distro}}.",
  "wsl.onboarding.opencodeReady": "VPS Code está listo.",
  "wsl.onboarding.installOpencodeIn": "Instala VPS Code en {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar VPS Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "VPS Code no está instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Se necesita WSL (Subsistema de Windows para Linux) para que VPS Code pueda añadir un servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "VPS Code no pudo comprobar WSL en este equipo.",
  "wsl.onboarding.installWsl": "Instalar WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicia Windows para terminar de instalar WSL y, después, vuelve a abrir VPS Code.",
  ...
  "help.tabs.introduction": "VPS Code Desktop ahora se organiza en torno a pestañas.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nueva versión de VPS Code ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Informa de este error al equipo de VPS Code",
  ...
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota: VPS Code aún no admite la autenticación MCP.',
  ...
  "session.preview.url": "URL de vista previa",
  "session.preview.reload": "Recargar vista previa",
  "session.preview.back": "Atrás",
  "session.preview.forward": "Adelante",
  "session.preview.openExternal": "Abrir en nueva pestaña",
  "session.preview.placeholder": "localhost:5173 o /preview/<puerto>/",
  "session.preview.empty": "La app aparecerá aquí en cuanto esté en marcha.",
  "session.preview.openBrowser": "Abrir navegador",
  "session.preview.console": "Consola",
  "session.preview.consoleEmpty": "Todavía no hay mensajes. Aquí salen logs, avisos, errores y peticiones fallidas.",
  "session.preview.responsive": "Responsive",
  "session.preview.responsive.desktop": "Escritorio",
  "session.preview.responsive.tablet": "Tableta",
  "session.preview.responsive.mobile": "Móvil",
  "session.preview.pickElement": "Seleccionar elemento",
  "session.preview.element": "elemento",
  "session.preview.zoomIn": "Acercar",
  "session.preview.zoomOut": "Alejar",
  "session.preview.zoom": "Zoom",
  "session.studio.views": "Vista previa y código",
  "session.studio.empty": "La app aparecerá aquí en cuanto esté en marcha.",
  "session.studio.download": "Descargar",
  "session.studio.downloadZip": "Descargar ZIP del proyecto",
  "session.studio.downloadFailed": "No se pudo descargar",
  "session.studio.fullscreen": "Pantalla completa",
  "session.studio.exitFullscreen": "Salir de pantalla completa",
  ...
  "sidebar.gettingStarted.line1": "VPS Code incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "app.name.desktop": "VPS Code Desktop",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor VPS Code dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para VPS Code",
  ...
  "settings.general.row.appearance.description": "Personaliza cómo se ve VPS Code en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si VPS Code sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de VPS Code.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia VPS Code",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de VPS Code.",
  ...
  "settings.skills.description": "Skills globales disponibles para todos los proyectos",
  "settings.skills.loading": "Cargando skills...",
  "settings.skills.empty": "No hay skills globales instaladas",
  "settings.skills.toast.updateFailed": "No se pudieron actualizar las skills",
