                ...
                <div class="flex w-max min-w-full justify-end gap-2">
                  <Index each={comments()}>
                    {(comment) => (
                      <div
                        classList={{
                          "shrink-0 max-w-[260px] rounded-[3px] border-border-weak-base bg-background-stronger px-2.5 py-2": true,
      ...
      >
        <Show
          ...
          fallback={
            ...
            >
              <div
                class="flex items-center justify-center w-8 h-6 rounded-[3px] border border-border-weaker-base bg-[color-mix(in_srgb,var(--surface-raised-stronger-non-alpha)_80%,transparent)] backdrop-blur-[0.75px] transition-colors group-hover:border-[var(--border-weak-base)] group-hover:[--icon-base:var(--icon-hover)]"
                style={{
                  "box-shadow":
                      ...
                      fallback={
                        <h1
                          ...
                          classList={{
                            ...
                            "w-fit rounded-[3px] px-2 py-1 hover:bg-v2-overlay-simple-overlay-hover":
                              settings.general.newLayoutDesigns(),
                    ...
                    >
                      <InlineInput
                        ...
                        classList={{
                          ...
                          "w-full flex-1 grow-1 min-w-0 pl-1 -ml-1 rounded-[3px]": !settings.general.newLayoutDesigns(),
                          "field-sizing-content self-start rounded-[3px] px-2 py-1 ":
                            settings.general.newLayoutDesigns(),
                        }}
                        style={{
                      ...
                      >
                        <KobaltePopover.Portal>
                          <KobaltePopover.Content
                            ...
                            classList={{
                              "flex w-80 max-w-none flex-col items-start gap-3 rounded-[3px] border border-v2-border-border-muted bg-v2-background-bg-layer-01 p-3 shadow-[var(--v2-elevation-floating)]":
                                settings.general.newLayoutDesigns(),
                            }}
                            ...
                            >
                              ...
                              <div class="flex w-full flex-col gap-2">
                                ...
                                >
                                  <div class="flex flex-col gap-2">
                                    <div
                                      class="flex h-8 w-full items-center gap-1.5 rounded-[3px] py-1 pl-2.5 pr-1.5 shadow-[var(--v2-elevation-button-neutral)]"
                                      style={{
                                        background:
