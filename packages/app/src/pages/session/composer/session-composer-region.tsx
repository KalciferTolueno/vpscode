          ...
          <Show
            ...
            fallback={
              <>
                ...
                <div
                  class="w-full min-h-32 md:min-h-40 rounded-[3px] border border-border-weak-base bg-background-base/50 px-4 py-3 text-text-weak whitespace-pre-wrap pointer-events-none"
            ...
            >
              ...
              >
                <div
                  ...
                  class="w-full rounded-[3px] border border-border-weak-base bg-background-base p-3 text-16-regular text-text-weak"
                >
