    ...
    >
      <div class="w-2/3 max-w-3xl flex flex-col items-center justify-center gap-8">
        ...
        <div class="flex flex-col items-center gap-2">
          <p class="text-sm text-text-weak text-center">{language.t("error.page.report.prefix")}</p>
          <p class="text-xs text-text-weak">
            {language.t("error.page.version", { version: platform.version ?? PRODUCT_VERSION })}
          </p>
        </div>
      </div>
    </div>
